...
int Xapian::InternalStemHungarian::r_mark_regions() { /* forwardmode */
    I_p1 = l; /* p1 = <integer expression>, line 46 */
    {   int c1 = c; /* or, line 51 */
        if (in_grouping_U(g_v, 97, 252, 0)) goto lab1; /* grouping v, line 48 */
        if (in_grouping_U(g_v, 97, 252, 1) < 0) goto lab1; /* goto */ /* non v, line 48 */
        {   int c2 = c; /* or, line 49 */
            if (c + 1 >= l || p[c + 1] >> 5 != 3 || !((101187584 >> (p[c + 1] & 0x1f)) & 1)) goto lab3; /* among, line 49 */
            if (!(find_among(a_0, 8, 0, 0))) goto lab3;
            goto lab2;
        lab3:
            c = c2;
    ...
    lab2:
        I_p1 = c; /* setmark p1, line 50 */
        goto lab0;
    lab1:
        c = c1;
        if (out_grouping_U(g_v, 97, 252, 0)) return 0; /* non v, line 53 */
        {   int ret = out_grouping_U(g_v, 97, 252, 1); /* gopast */ /* grouping v, line 53 */
            if (ret < 0) return 0;
            c += ret;
        }
        I_p1 = c; /* setmark p1, line 53 */
    }
lab0:
    return 1;
}

int Xapian::InternalStemHungarian::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* p1 <= <integer expression>, line 58 */
    return 1;
}

int Xapian::InternalStemHungarian::r_v_ending() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 61 */
    if (c - 1 <= lb || (p[c - 1] != 161 && p[c - 1] != 169)) return 0; /* substring, line 61 */
    among_var = find_among_b(a_1, 2, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 61 */
    {   int ret = r_R1(); /* call R1, line 61 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 61 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(1, s_0); /* <-, line 62 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(1, s_1); /* <-, line 63 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemHungarian::r_double() { /* backwardmode */
    {   int m_test1 = l - c; /* test, line 68 */
        if (c - 1 <= lb || p[c - 1] >> 5 != 3 || !((106790108 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* among, line 68 */
        if (!(find_among_b(a_2, 23, 0, 0))) return 0;
        c = l - m_test1;
    }
    return 1;
}

int Xapian::InternalStemHungarian::r_undouble() { /* backwardmode */
    {   int ret = skip_utf8(p, c, lb, 0, -1);
        if (ret < 0) return 0;
        c = ret; /* next, line 73 */
    }
    ket = c; /* [, line 73 */
    {   int ret = skip_utf8(p, c, lb, l, - 1); /* hop, line 73 */
        if (ret < 0) return 0;
        c = ret;
    }
    bra = c; /* ], line 73 */
...
int Xapian::InternalStemHungarian::r_instrum() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 77 */
    if (c - 1 <= lb || p[c - 1] != 108) return 0; /* substring, line 77 */
    ...
    switch(among_var) { /* among, line 77 */
        case 0: return 0;
        case 1:
            {   int ret = r_double(); /* call double, line 78 */
                if (ret <= 0) return ret;
            }
            break;
        case 2:
            {   int ret = r_double(); /* call double, line 79 */
                if (ret <= 0) return ret;
            }
            break;
    }
    if (slice_del() == -1) return -1; /* delete, line 81 */
    {   int ret = r_undouble(); /* call undouble, line 82 */
        if (ret <= 0) return ret;
    }
    return 1;
}

int Xapian::InternalStemHungarian::r_case() { /* backwardmode */
    ket = c; /* [, line 87 */
    if (!(find_among_b(a_4, 44, 0, 0))) return 0; /* substring, line 87 */
    bra = c; /* ], line 87 */
    {   int ret = r_R1(); /* call R1, line 87 */
        if (ret <= 0) return ret;
    }
    if (slice_del() == -1) return -1; /* delete, line 111 */
    {   int ret = r_v_ending(); /* call v_ending, line 112 */
        if (ret <= 0) return ret;
    }
    return 1;
}

int Xapian::InternalStemHungarian::r_case_special() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 116 */
    if (c - 2 <= lb || (p[c - 1] != 110 && p[c - 1] != 116)) return 0; /* substring, line 116 */
    ...
    switch(among_var) { /* among, line 116 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(1, s_2); /* <-, line 117 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(1, s_3); /* <-, line 118 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(1, s_4); /* <-, line 119 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemHungarian::r_case_other() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 124 */
    if (c - 3 <= lb || p[c - 1] != 108) return 0; /* substring, line 124 */
    among_var = find_among_b(a_6, 6, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 124 */
    ...
    switch(among_var) { /* among, line 124 */
        ...
        case 2:
            ...
            break;
        case 3:
            {   int ret = slice_from_s(1, s_5); /* <-, line 127 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            {   int ret = slice_from_s(1, s_6); /* <-, line 128 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemHungarian::r_factive() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 133 */
    if (c - 1 <= lb || (p[c - 1] != 161 && p[c - 1] != 169)) return 0; /* substring, line 133 */
    among_var = find_among_b(a_7, 2, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 133 */
    {   int ret = r_R1(); /* call R1, line 133 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 133 */
        case 0: return 0;
        case 1:
            {   int ret = r_double(); /* call double, line 134 */
                if (ret <= 0) return ret;
            }
            break;
        case 2:
            {   int ret = r_double(); /* call double, line 135 */
                if (ret <= 0) return ret;
            }
            break;
    }
    if (slice_del() == -1) return -1; /* delete, line 137 */
    {   int ret = r_undouble(); /* call undouble, line 138 */
        if (ret <= 0) return ret;
    }
    return 1;
}

int Xapian::InternalStemHungarian::r_plural() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 142 */
    if (c <= lb || p[c - 1] != 107) return 0; /* substring, line 142 */
    among_var = find_among_b(a_8, 7, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 142 */
    {   int ret = r_R1(); /* call R1, line 142 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 142 */
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(1, s_7); /* <-, line 143 */
                if (ret < 0) return ret;
            }
            break;
        case 2:
            {   int ret = slice_from_s(1, s_8); /* <-, line 144 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            ...
            break;
        case 4:
            if (slice_del() == -1) return -1; /* delete, line 146 */
            break;
        case 5:
            if (slice_del() == -1) return -1; /* delete, line 147 */
            break;
        case 6:
            if (slice_del() == -1) return -1; /* delete, line 148 */
            break;
        case 7:
...
int Xapian::InternalStemHungarian::r_owned() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 154 */
    if (c - 1 <= lb || (p[c - 1] != 105 && p[c - 1] != 169)) return 0; /* substring, line 154 */
    among_var = find_among_b(a_9, 12, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 154 */
    {   int ret = r_R1(); /* call R1, line 154 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 154 */
        case 0: return 0;
        case 1:
            if (slice_del() == -1) return -1; /* delete, line 155 */
            break;
        case 2:
            {   int ret = slice_from_s(1, s_9); /* <-, line 156 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(1, s_10); /* <-, line 157 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            break;
        case 5:
            {   int ret = slice_from_s(1, s_11); /* <-, line 159 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(1, s_12); /* <-, line 160 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
            if (slice_del() == -1) return -1; /* delete, line 161 */
            break;
        case 8:
            {   int ret = slice_from_s(1, s_13); /* <-, line 162 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
...
int Xapian::InternalStemHungarian::r_sing_owner() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 168 */
    among_var = find_among_b(a_10, 31, 0, 0); /* substring, line 168 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 168 */
    {   int ret = r_R1(); /* call R1, line 168 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 168 */
        ...
        case 1:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(1, s_14); /* <-, line 170 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(1, s_15); /* <-, line 171 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            break;
        case 5:
            {   int ret = slice_from_s(1, s_16); /* <-, line 173 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = slice_from_s(1, s_17); /* <-, line 174 */
                if (ret < 0) return ret;
            }
            break;
        case 7:
        ...
        case 9:
            ...
            break;
        case 10:
            {   int ret = slice_from_s(1, s_18); /* <-, line 178 */
                if (ret < 0) return ret;
            }
            break;
        case 11:
            {   int ret = slice_from_s(1, s_19); /* <-, line 179 */
                if (ret < 0) return ret;
            }
            break;
        case 12:
        ...
        case 13:
            ...
            break;
        case 14:
            {   int ret = slice_from_s(1, s_20); /* <-, line 182 */
                if (ret < 0) return ret;
            }
            break;
        case 15:
            {   int ret = slice_from_s(1, s_21); /* <-, line 183 */
                if (ret < 0) return ret;
            }
            break;
        case 16:
        ...
        case 17:
            ...
            break;
        case 18:
            if (slice_del() == -1) return -1; /* delete, line 186 */
            break;
        case 19:
            {   int ret = slice_from_s(1, s_22); /* <-, line 187 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            {   int ret = slice_from_s(1, s_23); /* <-, line 188 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemHungarian::r_plur_owner() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 193 */
    if (c <= lb || p[c - 1] >> 5 != 3 || !((10768 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* substring, line 193 */
    among_var = find_among_b(a_11, 42, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 193 */
    {   int ret = r_R1(); /* call R1, line 193 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 193 */
        ...
        case 1:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(1, s_24); /* <-, line 195 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            {   int ret = slice_from_s(1, s_25); /* <-, line 196 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            if (slice_del() == -1) return -1; /* delete, line 197 */
            break;
        case 5:
            if (slice_del() == -1) return -1; /* delete, line 198 */
            break;
        case 6:
            if (slice_del() == -1) return -1; /* delete, line 199 */
            break;
        case 7:
            {   int ret = slice_from_s(1, s_26); /* <-, line 200 */
                if (ret < 0) return ret;
            }
            break;
        case 8:
            {   int ret = slice_from_s(1, s_27); /* <-, line 201 */
                if (ret < 0) return ret;
            }
            break;
        case 9:
            ...
            break;
        case 10:
            if (slice_del() == -1) return -1; /* delete, line 203 */
            break;
        case 11:
            if (slice_del() == -1) return -1; /* delete, line 204 */
            break;
        case 12:
            {   int ret = slice_from_s(1, s_28); /* <-, line 205 */
                if (ret < 0) return ret;
            }
            break;
        case 13:
            {   int ret = slice_from_s(1, s_29); /* <-, line 206 */
                if (ret < 0) return ret;
            }
            break;
        case 14:
        ...
        case 16:
            ...
            break;
        case 17:
            if (slice_del() == -1) return -1; /* delete, line 210 */
            break;
        case 18:
            {   int ret = slice_from_s(1, s_30); /* <-, line 211 */
                if (ret < 0) return ret;
            }
            break;
        case 19:
            {   int ret = slice_from_s(1, s_31); /* <-, line 212 */
                if (ret < 0) return ret;
            }
            break;
        case 20:
            ...
            break;
        case 21:
            if (slice_del() == -1) return -1; /* delete, line 215 */
            break;
        case 22:
            {   int ret = slice_from_s(1, s_32); /* <-, line 216 */
                if (ret < 0) return ret;
            }
            break;
        case 23:
            {   int ret = slice_from_s(1, s_33); /* <-, line 217 */
                if (ret < 0) return ret;
            }
            break;
        case 24:
            if (slice_del() == -1) return -1; /* delete, line 218 */
            break;
        case 25:
            if (slice_del() == -1) return -1; /* delete, line 219 */
            break;
        case 26:
            if (slice_del() == -1) return -1; /* delete, line 220 */
            break;
        case 27:
            {   int ret = slice_from_s(1, s_34); /* <-, line 221 */
                if (ret < 0) return ret;
            }
            break;
        case 28:
            {   int ret = slice_from_s(1, s_35); /* <-, line 222 */
                if (ret < 0) return ret;
            }
            break;
        case 29:
            if (slice_del() == -1) return -1; /* delete, line 223 */
            break;
    }
    return 1;
}

int Xapian::InternalStemHungarian::stem() { /* forwardmode */
    {   int c1 = c; /* do, line 229 */
        {   int ret = r_mark_regions(); /* call mark_regions, line 229 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    lb = c; c = l; /* backwards, line 230 */

    {   int m2 = l - c; (void)m2; /* do, line 231 */
        {   int ret = r_instrum(); /* call instrum, line 231 */
            if (ret == 0) goto lab1;
            if (ret < 0) return ret;
        }
    lab1:
    ...
    {   int m3 = l - c; (void)m3; /* do, line 232 */
        {   int ret = r_case(); /* call case, line 232 */
            if (ret == 0) goto lab2;
            if (ret < 0) return ret;
        }
    lab2:
    ...
    {   int m4 = l - c; (void)m4; /* do, line 233 */
        {   int ret = r_case_special(); /* call case_special, line 233 */
            if (ret == 0) goto lab3;
            if (ret < 0) return ret;
        }
    lab3:
    ...
    {   int m5 = l - c; (void)m5; /* do, line 234 */
        {   int ret = r_case_other(); /* call case_other, line 234 */
            if (ret == 0) goto lab4;
            if (ret < 0) return ret;
        }
    lab4:
    ...
    {   int m6 = l - c; (void)m6; /* do, line 235 */
        {   int ret = r_factive(); /* call factive, line 235 */
            if (ret == 0) goto lab5;
            if (ret < 0) return ret;
        }
    lab5:
    ...
    {   int m7 = l - c; (void)m7; /* do, line 236 */
        {   int ret = r_owned(); /* call owned, line 236 */
            if (ret == 0) goto lab6;
            if (ret < 0) return ret;
        }
    lab6:
    ...
    {   int m8 = l - c; (void)m8; /* do, line 237 */
        {   int ret = r_sing_owner(); /* call sing_owner, line 237 */
            if (ret == 0) goto lab7;
            if (ret < 0) return ret;
        }
    lab7:
    ...
    {   int m9 = l - c; (void)m9; /* do, line 238 */
        {   int ret = r_plur_owner(); /* call plur_owner, line 238 */
            if (ret == 0) goto lab8;
            if (ret < 0) return ret;
        }
    lab8:
    ...
    {   int m10 = l - c; (void)m10; /* do, line 239 */
        {   int ret = r_plural(); /* call plural, line 239 */
            if (ret == 0) goto lab9;
            if (ret < 0) return ret;
        }
    lab9:
...
const char *
Xapian::InternalStemHungarian::get_description() const
{
    return "hungarian";
}
