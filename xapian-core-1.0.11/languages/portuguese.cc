...
int Xapian::InternalStemPortuguese::r_prelude() { /* forwardmode */
    int among_var;
    while(1) { /* repeat, line 36 */
        int c1 = c;
        bra = c; /* [, line 37 */
        if (c + 1 >= l || (p[c + 1] != 163 && p[c + 1] != 181)) among_var = 3; else /* substring, line 37 */
...
int Xapian::InternalStemPortuguese::r_mark_regions() { /* forwardmode */
    I_pV = l; /* pV = <integer expression>, line 46 */
    I_p1 = l; /* p1 = <integer expression>, line 47 */
    I_p2 = l; /* p2 = <integer expression>, line 48 */
    {   int c1 = c; /* do, line 50 */
        {   int c2 = c; /* or, line 52 */
            if (in_grouping_U(g_v, 97, 250, 0)) goto lab2; /* grouping v, line 51 */
            {   int c3 = c; /* or, line 51 */
                if (out_grouping_U(g_v, 97, 250, 0)) goto lab4; /* non v, line 51 */
                {   int ret = out_grouping_U(g_v, 97, 250, 1); /* gopast */ /* grouping v, line 51 */
                    if (ret < 0) goto lab4;
                    c += ret;
                }
                goto lab3;
            lab4:
                c = c3;
                if (in_grouping_U(g_v, 97, 250, 0)) goto lab2; /* grouping v, line 51 */
                {   int ret = in_grouping_U(g_v, 97, 250, 1); /* gopast */ /* non v, line 51 */
                    if (ret < 0) goto lab2;
                    c += ret;
                }
            }
        ...
        lab2:
            c = c2;
            if (out_grouping_U(g_v, 97, 250, 0)) goto lab0; /* non v, line 53 */
            {   int c4 = c; /* or, line 53 */
                if (out_grouping_U(g_v, 97, 250, 0)) goto lab6; /* non v, line 53 */
                {   int ret = out_grouping_U(g_v, 97, 250, 1); /* gopast */ /* grouping v, line 53 */
                    if (ret < 0) goto lab6;
                    c += ret;
                }
                goto lab5;
            lab6:
                c = c4;
                if (in_grouping_U(g_v, 97, 250, 0)) goto lab0; /* grouping v, line 53 */
                {   int ret = skip_utf8(p, c, 0, l, 1);
                    if (ret < 0) goto lab0;
                    c = ret; /* next, line 53 */
                }
    ...
    lab1:
        I_pV = c; /* setmark pV, line 54 */
    lab0:
        c = c1;
    }
    {   int c5 = c; /* do, line 56 */
        {   int ret = out_grouping_U(g_v, 97, 250, 1); /* gopast */ /* grouping v, line 57 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        {   int ret = in_grouping_U(g_v, 97, 250, 1); /* gopast */ /* non v, line 57 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        I_p1 = c; /* setmark p1, line 57 */
        {   int ret = out_grouping_U(g_v, 97, 250, 1); /* gopast */ /* grouping v, line 58 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        {   int ret = in_grouping_U(g_v, 97, 250, 1); /* gopast */ /* non v, line 58 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        I_p2 = c; /* setmark p2, line 58 */
    lab7:
        c = c5;
    }
    return 1;
...
int Xapian::InternalStemPortuguese::r_postlude() { /* forwardmode */
    int among_var;
    while(1) { /* repeat, line 62 */
        int c1 = c;
        bra = c; /* [, line 63 */
        if (c + 1 >= l || p[c + 1] != 126) among_var = 3; else /* substring, line 63 */
        among_var = find_among(a_1, 3, 0, 0);
        if (!(among_var)) goto lab0;
        ket = c; /* ], line 63 */
        switch(among_var) { /* among, line 63 */
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(2, s_2); /* <-, line 64 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(2, s_3); /* <-, line 65 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
...
int Xapian::InternalStemPortuguese::r_RV() { /* backwardmode */
    if (!(I_pV <= c)) return 0; /* pV <= <integer expression>, line 72 */
    return 1;
}

int Xapian::InternalStemPortuguese::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* p1 <= <integer expression>, line 73 */
    return 1;
}

int Xapian::InternalStemPortuguese::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* p2 <= <integer expression>, line 74 */
    return 1;
}

int Xapian::InternalStemPortuguese::r_standard_suffix() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 77 */
    if (c - 2 <= lb || p[c - 1] >> 5 != 3 || !((839714 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* substring, line 77 */
    among_var = find_among_b(a_5, 45, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 77 */
    switch(among_var) { /* among, line 77 */
        case 0: return 0;
        case 1:
            {   int ret = r_R2(); /* call R2, line 93 */
                if (ret <= 0) return ret;
            }
        ...
        case 2:
            ...
            {   int ret = slice_from_s(3, s_4); /* <-, line 98 */
                if (ret < 0) return ret;
            }
            break;
        case 3:
            ...
            {   int ret = slice_from_s(1, s_5); /* <-, line 102 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = slice_from_s(4, s_6); /* <-, line 106 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int m1 = l - c; (void)m1; /* try, line 111 */
                ket = c; /* [, line 112 */
                if (c - 1 <= lb || p[c - 1] >> 5 != 3 || !((4718616 >> (p[c - 1] & 0x1f)) & 1)) { c = l - m1; goto lab0; } /* substring, line 112 */
                ...
                switch(among_var) { /* among, line 112 */
                    ...
                    case 1:
                        ket = c; /* [, line 113 */
                        if (!(eq_s_b(2, s_7))) { c = l - m1; goto lab0; } /* literal, line 113 */
                        bra = c; /* ], line 113 */
        ...
        case 6:
            ...
            {   int m2 = l - c; (void)m2; /* try, line 123 */
                ket = c; /* [, line 124 */
                if (c - 3 <= lb || (p[c - 1] != 101 && p[c - 1] != 108)) { c = l - m2; goto lab1; } /* substring, line 124 */
                among_var = find_among_b(a_3, 3, 0, 0);
        ...
        case 7:
            ...
            {   int m3 = l - c; (void)m3; /* try, line 135 */
                ket = c; /* [, line 136 */
                if (c - 1 <= lb || p[c - 1] >> 5 != 3 || !((4198408 >> (p[c - 1] & 0x1f)) & 1)) { c = l - m3; goto lab2; } /* substring, line 136 */
                among_var = find_among_b(a_4, 3, 0, 0);
                if (!(among_var)) { c = l - m3; goto lab2; }
                bra = c; /* ], line 136 */
                switch(among_var) { /* among, line 136 */
            ...
            break;
        case 8:
            {   int ret = r_R2(); /* call R2, line 146 */
                if (ret <= 0) return ret;
            }
            if (slice_del() == -1) return -1; /* delete, line 146 */
            {   int m4 = l - c; (void)m4; /* try, line 147 */
                ket = c; /* [, line 148 */
                if (!(eq_s_b(2, s_8))) { c = l - m4; goto lab3; } /* literal, line 148 */
                bra = c; /* ], line 148 */
                {   int ret = r_R2(); /* call R2, line 148 */
            ...
            break;
        case 9:
            {   int ret = r_RV(); /* call RV, line 153 */
                if (ret <= 0) return ret;
            }
            if (c <= lb || p[c - 1] != 'e') return 0;
            c--;
            {   int ret = slice_from_s(2, s_9); /* <-, line 154 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemPortuguese::r_verb_suffix() { /* backwardmode */
    int among_var;
    {   int m1 = l - c; (void)m1; /* setlimit, line 159 */
        int mlimit1;
        if (c < I_pV) return 0;
        c = I_pV; /* tomark, line 159 */
        mlimit1 = lb; lb = c;
        c = l - m1;
        ket = c; /* [, line 160 */
        among_var = find_among_b(a_6, 120, 0, 0); /* substring, line 160 */
...
int Xapian::InternalStemPortuguese::r_residual_suffix() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 184 */
    among_var = find_among_b(a_7, 7, 0, 0); /* substring, line 184 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 184 */
    switch(among_var) { /* among, line 184 */
        case 0: return 0;
        case 1:
            {   int ret = r_RV(); /* call RV, line 187 */
                if (ret <= 0) return ret;
            }
...
int Xapian::InternalStemPortuguese::r_residual_form() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 192 */
    among_var = find_among_b(a_8, 4, 0, 0); /* substring, line 192 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 192 */
    switch(among_var) { /* among, line 192 */
        case 0: return 0;
        case 1:
            {   int ret = r_RV(); /* call RV, line 194 */
                if (ret <= 0) return ret;
            }
            if (slice_del() == -1) return -1; /* delete, line 194 */
            ket = c; /* [, line 194 */
            {   int m1 = l - c; (void)m1; /* or, line 194 */
                if (c <= lb || p[c - 1] != 'u') goto lab1;
                c--;
                bra = c; /* ], line 194 */
                {   int m_test2 = l - c; /* test, line 194 */
        ...
        lab0:
            {   int ret = r_RV(); /* call RV, line 195 */
                if (ret <= 0) return ret;
            }
            if (slice_del() == -1) return -1; /* delete, line 195 */
            break;
        case 2:
            {   int ret = slice_from_s(1, s_10); /* <-, line 196 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemPortuguese::stem() { /* forwardmode */
    {   int c1 = c; /* do, line 202 */
        {   int ret = r_prelude(); /* call prelude, line 202 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    {   int m3 = l - c; (void)m3; /* do, line 205 */
        {   int m4 = l - c; (void)m4; /* or, line 209 */
            {   int m5 = l - c; (void)m5; /* and, line 207 */
                {   int m6 = l - c; (void)m6; /* or, line 206 */
                    {   int ret = r_standard_suffix(); /* call standard_suffix, line 206 */
                        if (ret == 0) goto lab6;
                        if (ret < 0) return ret;
                    }
                    goto lab5;
                lab6:
                    c = l - m6;
                    {   int ret = r_verb_suffix(); /* call verb_suffix, line 206 */
                        if (ret == 0) goto lab4;
                        if (ret < 0) return ret;
                    }
                }
            lab5:
                c = l - m5;
                {   int m7 = l - c; (void)m7; /* do, line 207 */
                    ket = c; /* [, line 207 */
                    if (c <= lb || p[c - 1] != 'i') goto lab7;
                    c--;
                    bra = c; /* ], line 207 */
                    {   int m_test8 = l - c; /* test, line 207 */
                        if (c <= lb || p[c - 1] != 'c') goto lab7;
                        c--;
                        c = l - m_test8;
                    }
                    {   int ret = r_RV(); /* call RV, line 207 */
                        if (ret == 0) goto lab7;
                        if (ret < 0) return ret;
                    }
        ...
        lab4:
            c = l - m4;
            {   int ret = r_residual_suffix(); /* call residual_suffix, line 209 */
                if (ret == 0) goto lab2;
                if (ret < 0) return ret;
            }
        }
    ...
    {   int m9 = l - c; (void)m9; /* do, line 211 */
        {   int ret = r_residual_form(); /* call residual_form, line 211 */
            if (ret == 0) goto lab8;
            if (ret < 0) return ret;
        }
    lab8:
    ...
    c = lb;
    {   int c10 = c; /* do, line 213 */
        {   int ret = r_postlude(); /* call postlude, line 213 */
            if (ret == 0) goto lab9;
            if (ret < 0) return ret;
        }
    lab9:
...
const char *
Xapian::InternalStemPortuguese::get_description() const
{
    return "portuguese";
}
