...
int Xapian::InternalStemItalian::r_prelude() { /* forwardmode */
    ...
    {   int c_test1 = c; /* test, line 35 */
        while(1) { /* repeat, line 35 */
            int c2 = c;
            bra = c; /* [, line 36 */
            among_var = find_among(a_0, 7, 0, 0); /* substring, line 36 */
            if (!(among_var)) goto lab0;
            ket = c; /* ], line 36 */
            switch(among_var) { /* among, line 36 */
                case 0: goto lab0;
                case 1:
                    {   int ret = slice_from_s(2, s_0); /* <-, line 37 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    {   int ret = slice_from_s(2, s_2); /* <-, line 39 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 4:
                    {   int ret = slice_from_s(2, s_3); /* <-, line 40 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 5:
                    {   int ret = slice_from_s(2, s_4); /* <-, line 41 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 6:
                    {   int ret = slice_from_s(2, s_5); /* <-, line 42 */
                        if (ret < 0) return ret;
                    }
                    break;
                case 7:
    ...
    while(1) { /* repeat, line 46 */
        ...
        while(1) { /* goto, line 46 */
            int c4 = c;
            if (in_grouping_U(g_v, 97, 249, 0)) goto lab2; /* grouping v, line 47 */
            bra = c; /* [, line 47 */
            {   int c5 = c; /* or, line 47 */
                if (c == l || p[c] != 'u') goto lab4;
                c++;
                ket = c; /* ], line 47 */
                if (in_grouping_U(g_v, 97, 249, 0)) goto lab4; /* grouping v, line 47 */
                {   int ret = slice_from_s(1, s_6); /* <-, line 47 */
                    if (ret < 0) return ret;
                }
                goto lab3;
            lab4:
                c = c5;
                if (c == l || p[c] != 'i') goto lab2;
                c++;
                ket = c; /* ], line 48 */
                if (in_grouping_U(g_v, 97, 249, 0)) goto lab2; /* grouping v, line 48 */
                {   int ret = slice_from_s(1, s_7); /* <-, line 48 */
                    if (ret < 0) return ret;
                }
            }
        lab3:
...
int Xapian::InternalStemItalian::r_mark_regions() { /* forwardmode */
    ...
    {   int c1 = c; /* do, line 58 */
        {   int c2 = c; /* or, line 60 */
            if (in_grouping_U(g_v, 97, 249, 0)) goto lab2; /* grouping v, line 59 */
            {   int c3 = c; /* or, line 59 */
                if (out_grouping_U(g_v, 97, 249, 0)) goto lab4; /* non v, line 59 */
                {   int ret = out_grouping_U(g_v, 97, 249, 1); /* gopast */ /* grouping v, line 59 */
                    if (ret < 0) goto lab4;
                    c += ret;
                }
                goto lab3;
            lab4:
                c = c3;
                if (in_grouping_U(g_v, 97, 249, 0)) goto lab2; /* grouping v, line 59 */
                {   int ret = in_grouping_U(g_v, 97, 249, 1); /* gopast */ /* non v, line 59 */
                    if (ret < 0) goto lab2;
                    c += ret;
                }
            }
        ...
        lab2:
            c = c2;
            if (out_grouping_U(g_v, 97, 249, 0)) goto lab0; /* non v, line 61 */
            {   int c4 = c; /* or, line 61 */
                if (out_grouping_U(g_v, 97, 249, 0)) goto lab6; /* non v, line 61 */
                {   int ret = out_grouping_U(g_v, 97, 249, 1); /* gopast */ /* grouping v, line 61 */
                    if (ret < 0) goto lab6;
                    c += ret;
                }
                goto lab5;
            lab6:
                c = c4;
                if (in_grouping_U(g_v, 97, 249, 0)) goto lab0; /* grouping v, line 61 */
                {   int ret = skip_utf8(p, c, 0, l, 1);
                    if (ret < 0) goto lab0;
                    c = ret; /* next, line 61 */
                }
    ...
    {   int c5 = c; /* do, line 64 */
        {   int ret = out_grouping_U(g_v, 97, 249, 1); /* gopast */ /* grouping v, line 65 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        {   int ret = in_grouping_U(g_v, 97, 249, 1); /* gopast */ /* non v, line 65 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        I_p1 = c; /* setmark p1, line 65 */
        {   int ret = out_grouping_U(g_v, 97, 249, 1); /* gopast */ /* grouping v, line 66 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        {   int ret = in_grouping_U(g_v, 97, 249, 1); /* gopast */ /* non v, line 66 */
            if (ret < 0) goto lab7;
            c += ret;
        }
        I_p2 = c; /* setmark p2, line 66 */
    lab7:
        c = c5;
    }
    return 1;
...
int Xapian::InternalStemItalian::r_postlude() { /* forwardmode */
    ...
    while(1) { /* repeat, line 70 */
        int c1 = c;
        bra = c; /* [, line 72 */
        if (c >= l || (p[c + 0] != 73 && p[c + 0] != 85)) among_var = 3; else /* substring, line 72 */
        ...
        switch(among_var) { /* among, line 72 */
            case 0: goto lab0;
            case 1:
                {   int ret = slice_from_s(1, s_8); /* <-, line 73 */
                    if (ret < 0) return ret;
                }
                break;
            case 2:
                {   int ret = slice_from_s(1, s_9); /* <-, line 74 */
                    if (ret < 0) return ret;
                }
                break;
            case 3:
...
int Xapian::InternalStemItalian::r_RV() { /* backwardmode */
    if (!(I_pV <= c)) return 0; /* pV <= <integer expression>, line 82 */
    return 1;
}

int Xapian::InternalStemItalian::r_R1() { /* backwardmode */
    if (!(I_p1 <= c)) return 0; /* p1 <= <integer expression>, line 83 */
    return 1;
}

int Xapian::InternalStemItalian::r_R2() { /* backwardmode */
    if (!(I_p2 <= c)) return 0; /* p2 <= <integer expression>, line 84 */
    return 1;
}
...
int Xapian::InternalStemItalian::r_attached_pronoun() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 87 */
    if (c - 1 <= lb || p[c - 1] >> 5 != 3 || !((33314 >> (p[c - 1] & 0x1f)) & 1)) return 0; /* substring, line 87 */
    if (!(find_among_b(a_2, 37, 0, 0))) return 0;
    bra = c; /* ], line 87 */
    if (c - 1 <= lb || (p[c - 1] != 111 && p[c - 1] != 114)) return 0; /* among, line 97 */
    among_var = find_among_b(a_3, 5, 0, 0);
    if (!(among_var)) return 0;
    {   int ret = r_RV(); /* call RV, line 97 */
        if (ret <= 0) return ret;
    }
    switch(among_var) { /* among, line 97 */
        ...
        case 1:
            ...
            break;
        case 2:
            {   int ret = slice_from_s(1, s_10); /* <-, line 99 */
                if (ret < 0) return ret;
            }
            break;
    }
...
int Xapian::InternalStemItalian::r_standard_suffix() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 104 */
    among_var = find_among_b(a_6, 51, 0, 0); /* substring, line 104 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 104 */
    switch(among_var) { /* among, line 104 */
        ...
        case 2:
            ...
            {   int m1 = l - c; (void)m1; /* try, line 114 */
                ket = c; /* [, line 114 */
                if (!(eq_s_b(2, s_11))) { c = l - m1; goto lab0; } /* literal, line 114 */
                bra = c; /* ], line 114 */
        ...
        case 3:
            ...
            {   int ret = slice_from_s(3, s_12); /* <-, line 117 */
                if (ret < 0) return ret;
            }
            break;
        case 4:
            ...
            {   int ret = slice_from_s(1, s_13); /* <-, line 119 */
                if (ret < 0) return ret;
            }
            break;
        case 5:
            ...
            {   int ret = slice_from_s(4, s_14); /* <-, line 121 */
                if (ret < 0) return ret;
            }
            break;
        case 6:
            {   int ret = r_RV(); /* call RV, line 123 */
                if (ret <= 0) return ret;
            }
            if (slice_del() == -1) return -1; /* delete, line 123 */
            break;
        case 7:
            {   int ret = r_R1(); /* call R1, line 125 */
                if (ret <= 0) return ret;
            }
            if (slice_del() == -1) return -1; /* delete, line 125 */
            {   int m2 = l - c; (void)m2; /* try, line 126 */
                ket = c; /* [, line 127 */
                if (c - 1 <= lb || p[c - 1] >> 5 != 3 || !((4722696 >> (p[c - 1] & 0x1f)) & 1)) { c = l - m2; goto lab1; } /* substring, line 127 */
                among_var = find_among_b(a_4, 4, 0, 0);
                ...
                switch(among_var) { /* among, line 127 */
                    ...
                    case 1:
                        ket = c; /* [, line 128 */
                        if (!(eq_s_b(2, s_15))) { c = l - m2; goto lab1; } /* literal, line 128 */
                        bra = c; /* ], line 128 */
        ...
        case 9:
            ...
            {   int m4 = l - c; (void)m4; /* try, line 143 */
                ket = c; /* [, line 143 */
                if (!(eq_s_b(2, s_16))) { c = l - m4; goto lab3; } /* literal, line 143 */
                bra = c; /* ], line 143 */
                ...
                ket = c; /* [, line 143 */
                if (!(eq_s_b(2, s_17))) { c = l - m4; goto lab3; } /* literal, line 143 */
                bra = c; /* ], line 143 */
                {   int ret = r_R2(); /* call R2, line 143 */
                    if (ret == 0) { c = l - m4; goto lab3; }
                    if (ret < 0) return ret;
...
int Xapian::InternalStemItalian::r_verb_suffix() { /* backwardmode */
    int among_var;
    {   int m1 = l - c; (void)m1; /* setlimit, line 148 */
        int mlimit1;
        if (c < I_pV) return 0;
        c = I_pV; /* tomark, line 148 */
        mlimit1 = lb; lb = c;
        c = l - m1;
        ket = c; /* [, line 149 */
        among_var = find_among_b(a_7, 87, 0, 0); /* substring, line 149 */
        if (!(among_var)) { lb = mlimit1; return 0; }
        bra = c; /* ], line 149 */
        switch(among_var) { /* among, line 149 */
...
int Xapian::InternalStemItalian::r_vowel_suffix() { /* backwardmode */
    {   int m1 = l - c; (void)m1; /* try, line 171 */
        ket = c; /* [, line 172 */
        if (in_grouping_b_U(g_AEIO, 97, 242, 0)) { c = l - m1; goto lab0; } /* grouping AEIO, line 172 */
        bra = c; /* ], line 172 */
        {   int ret = r_RV(); /* call RV, line 172 */
            if (ret == 0) { c = l - m1; goto lab0; }
            if (ret < 0) return ret;
        }
        if (slice_del() == -1) return -1; /* delete, line 172 */
        ket = c; /* [, line 173 */
        if (c <= lb || p[c - 1] != 'i') { c = l - m1; goto lab0; }
        c--;
        bra = c; /* ], line 173 */
    ...
    {   int m2 = l - c; (void)m2; /* try, line 175 */
        ket = c; /* [, line 176 */
        if (c <= lb || p[c - 1] != 'h') { c = l - m2; goto lab1; }
        c--;
        bra = c; /* ], line 176 */
        if (in_grouping_b_U(g_CG, 99, 103, 0)) { c = l - m2; goto lab1; } /* grouping CG, line 176 */
        {   int ret = r_RV(); /* call RV, line 176 */
            if (ret == 0) { c = l - m2; goto lab1; }
            if (ret < 0) return ret;
        }
...
int Xapian::InternalStemItalian::stem() { /* forwardmode */
    {   int c1 = c; /* do, line 182 */
        {   int ret = r_prelude(); /* call prelude, line 182 */
            if (ret == 0) goto lab0;
            if (ret < 0) return ret;
        }
    lab0:
    ...
    {   int c2 = c; /* do, line 183 */
        {   int ret = r_mark_regions(); /* call mark_regions, line 183 */
            if (ret == 0) goto lab1;
            if (ret < 0) return ret;
        }
    lab1:
    ...
    lb = c; c = l; /* backwards, line 184 */

    {   int m3 = l - c; (void)m3; /* do, line 185 */
        {   int ret = r_attached_pronoun(); /* call attached_pronoun, line 185 */
            if (ret == 0) goto lab2;
            if (ret < 0) return ret;
        }
    lab2:
    ...
    {   int m4 = l - c; (void)m4; /* do, line 186 */
        {   int m5 = l - c; (void)m5; /* or, line 186 */
            {   int ret = r_standard_suffix(); /* call standard_suffix, line 186 */
                if (ret == 0) goto lab5;
                if (ret < 0) return ret;
            }
            goto lab4;
        lab5:
            c = l - m5;
            {   int ret = r_verb_suffix(); /* call verb_suffix, line 186 */
                if (ret == 0) goto lab3;
                if (ret < 0) return ret;
            }
        }
    ...
    {   int m6 = l - c; (void)m6; /* do, line 187 */
        {   int ret = r_vowel_suffix(); /* call vowel_suffix, line 187 */
            if (ret == 0) goto lab6;
            if (ret < 0) return ret;
        }
    lab6:
    ...
    c = lb;
    {   int c7 = c; /* do, line 189 */
        {   int ret = r_postlude(); /* call postlude, line 189 */
            if (ret == 0) goto lab7;
            if (ret < 0) return ret;
        }
    lab7:
