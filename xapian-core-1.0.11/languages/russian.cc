...
int Xapian::InternalStemRussian::r_perfective_gerund() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 72 */
    among_var = find_among_b(a_0, 9, 0, 0); /* substring, line 72 */
...
int Xapian::InternalStemRussian::r_adjective() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 88 */
    among_var = find_among_b(a_1, 26, 0, 0); /* substring, line 88 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 88 */
...
int Xapian::InternalStemRussian::r_adjectival() { /* backwardmode */
    ...
    {   int m1 = l - c; (void)m1; /* try, line 109 */
        ket = c; /* [, line 110 */
        among_var = find_among_b(a_2, 8, 0, 0); /* substring, line 110 */
...
int Xapian::InternalStemRussian::r_verb() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 137 */
    among_var = find_among_b(a_4, 46, 0, 0); /* substring, line 137 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 137 */
...
int Xapian::InternalStemRussian::r_noun() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 160 */
    among_var = find_among_b(a_5, 36, 0, 0); /* substring, line 160 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 160 */
...
int Xapian::InternalStemRussian::r_derivational() { /* backwardmode */
    ...
    among_var = find_among_b(a_6, 2, 0, 0);
    if (!(among_var)) return 0;
    bra = c; /* ], line 176 */
...
int Xapian::InternalStemRussian::r_tidy_up() { /* backwardmode */
    int among_var;
    ket = c; /* [, line 184 */
    among_var = find_among_b(a_7, 4, 0, 0); /* substring, line 184 */
    if (!(among_var)) return 0;
    bra = c; /* ], line 184 */
