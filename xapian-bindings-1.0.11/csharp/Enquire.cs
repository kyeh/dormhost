...
public class Enquire : IDisposable {
  ...
  public void SetSortByKey(Sorter sorter, bool ascending) {
    XapianPINVOKE.Enquire_SetSortByKey__SWIG_0(swigCPtr, Sorter.getCPtr(sorter), ascending);
    if (XapianPINVOKE.SWIGPendingException.Pending) throw XapianPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void SetSortByRelevanceThenKey(Sorter sorter, bool ascending) {
    XapianPINVOKE.Enquire_SetSortByRelevanceThenKey__SWIG_0(swigCPtr, Sorter.getCPtr(sorter), ascending);
    if (XapianPINVOKE.SWIGPendingException.Pending) throw XapianPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public MSet GetMSet(uint first, uint maxitems, uint checkatleast, RSet omrset, MatchDecider mdecider, MatchDecider matchspy) {
    MSet ret = new MSet(XapianPINVOKE.Enquire_GetMSet__SWIG_4(swigCPtr, first, maxitems, checkatleast, RSet.getCPtr(omrset), MatchDecider.getCPtr(mdecider), MatchDecider.getCPtr(matchspy)), true);
    if (XapianPINVOKE.SWIGPendingException.Pending) throw XapianPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
