...
#define SWIGTYPE_p_Xapian__DateValueRangeProcessor swig_types[3]
...
#define SWIGTYPE_p_docid_order swig_types[32]
#define SWIGTYPE_p_double swig_types[33]
#define SWIGTYPE_p_feature_flag swig_types[34]
...
#define SWIGTYPE_p_stem_strategy swig_types[40]
...
/*@SWIG:/data/home/olly/tmp/xapian-svn-snapshot/tags/1.0.11/xapian/swig/Lib/ruby/rubyprimtypes.swg,23,%ruby_aux_method@*/
...
SwigDirector_Sorter::SwigDirector_Sorter(VALUE self): Xapian::Sorter(), Swig::Director(self) {
...
_wrap_ValueIterator_valueno(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__ValueIterator, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::ValueIterator *","get_valueno", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::ValueIterator * >(argp1);
  {
    try {
...
_wrap_ESetIterator_termname(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::ESetIterator const *","get_termname", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::ESetIterator * >(argp1);
  {
    try {
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.sort_by_value!", 
    "    void Enquire.sort_by_value!(Xapian::valueno sort_key, bool ascending)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.sort_by_value_then_relevance!", 
    "    void Enquire.sort_by_value_then_relevance!(Xapian::valueno sort_key, bool ascending)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.sort_by_relevance_then_value!", 
    "    void Enquire.sort_by_relevance_then_value!(Xapian::valueno sort_key, bool ascending)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.set_sort_by_key", 
    "    void Enquire.set_sort_by_key(Xapian::Sorter *sorter, bool ascending)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.set_sort_by_key_then_relevance", 
    "    void Enquire.set_sort_by_key_then_relevance(Xapian::Sorter *sorter, bool ascending)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.set_sort_by_relevance_then_key", 
    "    void Enquire.set_sort_by_relevance_then_key(Xapian::Sorter *sorter, bool ascending)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 7, "Enquire.eset", 
...
_wrap_Enquire_register_match_decider__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__Enquire, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::Enquire *","register_match_decider", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::Enquire * >(argp1);
  {
    std::string *ptr = (std::string *)0;
    res2 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","register_match_decider", 2, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","register_match_decider", 2, argv[0])); 
    }
    arg2 = ptr;
  }
  res3 = SWIG_ConvertPtr(argv[1], &argp3,SWIGTYPE_p_Xapian__MatchDecider, 0 |  0 );
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), Ruby_Format_TypeError( "", "Xapian::MatchDecider const *","register_match_decider", 3, argv[1] )); 
  }
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Enquire.register_match_decider", 
    "    void Enquire.register_match_decider(std::string const &name, Xapian::MatchDecider const *mdecider)\n"
    "    void Enquire.register_match_decider(std::string const &name)\n");
...
_wrap_Weight_serialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__Weight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::Weight const *","serialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::Weight * >(argp1);
  {
    try {
...
_wrap_Weight_unserialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__Weight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::Weight const *","unserialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::Weight * >(argp1);
  {
    std::string *ptr = (std::string *)0;
...
_wrap_Weight_sumpart(int argc, VALUE *argv, VALUE self) {
  ...
  ecode3 = SWIG_AsVal_double(argv[1], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "Xapian::doclength","get_sumpart", 3, argv[1] ));
  } 
...
_wrap_Weight_sumextra(int argc, VALUE *argv, VALUE self) {
  ...
  ecode2 = SWIG_AsVal_double(argv[0], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "Xapian::doclength","get_sumextra", 2, argv[0] ));
  } 
...
_wrap_Weight_sumpart_needs_doclength(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__Weight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::Weight const *","get_sumpart_needs_doclength", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::Weight * >(argp1);
  {
    try {
...
/*
  Document-method: Xapian::BoolWeight.clone
...
_wrap_BoolWeight_clone(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BoolWeight const *","clone", 1, self )); 
  }
...
_wrap_BoolWeight_serialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__BoolWeight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BoolWeight const *","serialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::BoolWeight * >(argp1);
  {
    try {
...
_wrap_BoolWeight_unserialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__BoolWeight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BoolWeight const *","unserialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::BoolWeight * >(argp1);
  {
    std::string *ptr = (std::string *)0;
...
_wrap_BoolWeight_sumpart_needs_doclength(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__BoolWeight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BoolWeight const *","get_sumpart_needs_doclength", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::BoolWeight * >(argp1);
  {
    try {
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "BM25Weight.new", 
    "    BM25Weight.new(double k1_, double k2_, double k3_, double b_, double min_normlen_)\n"
    "    BM25Weight.new()\n");
...
/*
  Document-method: Xapian::BM25Weight.clone
...
_wrap_BM25Weight_clone(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BM25Weight const *","clone", 1, self )); 
  }
...
_wrap_BM25Weight_serialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__BM25Weight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BM25Weight const *","serialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::BM25Weight * >(argp1);
  {
    try {
...
_wrap_BM25Weight_unserialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__BM25Weight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BM25Weight const *","unserialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::BM25Weight * >(argp1);
  {
    std::string *ptr = (std::string *)0;
...
_wrap_BM25Weight_sumpart_needs_doclength(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__BM25Weight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::BM25Weight const *","get_sumpart_needs_doclength", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::BM25Weight * >(argp1);
  {
    try {
...
/*
  Document-method: Xapian::TradWeight.clone
...
_wrap_TradWeight_clone(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::TradWeight const *","clone", 1, self )); 
  }
...
_wrap_TradWeight_serialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__TradWeight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::TradWeight const *","serialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::TradWeight * >(argp1);
  {
    try {
...
_wrap_TradWeight_unserialise(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__TradWeight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::TradWeight const *","unserialise", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::TradWeight * >(argp1);
  {
    std::string *ptr = (std::string *)0;
...
_wrap_TradWeight_sumpart_needs_doclength(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__TradWeight, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::TradWeight const *","get_sumpart_needs_doclength", 1, self )); 
  }
  arg1 = reinterpret_cast< Xapian::TradWeight * >(argp1);
  {
    try {
...
_wrap_quartz_open__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = SWIG_AsPtr_std_string(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::string const &","Xapian::Quartz::open", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","Xapian::Quartz::open", 1, argv[0])); 
    }
    arg1 = ptr;
  }
  {
...
_wrap_quartz_open__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  ecode2 = SWIG_AsVal_int(argv[1], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "int","Xapian::Quartz::open", 2, argv[1] ));
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "int","Xapian::Quartz::open", 3, argv[2] ));
  } 
...
fail:
  Ruby_Format_OverloadedError( argc, 3, "quartz_open", 
    "    Xapian::WritableDatabase quartz_open(std::string const &dir)\n"
    "    Xapian::WritableDatabase quartz_open(std::string const &dir, int action, int block_size)\n"
    "    Xapian::WritableDatabase quartz_open(std::string const &dir, int action)\n");
...
_wrap_new_Query__SWIG_6(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::Query *)new Xapian::Query(arg1,arg2,(std::string const &)*arg3,(std::string const &)*arg4);DATA_PTR(self) = result;
...
_wrap_new_Query__SWIG_7(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::Query *)new Xapian::Query(arg1,arg2,(std::string const &)*arg3);DATA_PTR(self) = result;
...
_wrap_new_Query__SWIG_8(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::Query *)new_Xapian_Query__SWIG_8(arg1,(std::vector<Xapian::Query > const &)*arg2,arg3);DATA_PTR(self) = result;
...
_wrap_new_Query__SWIG_9(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::Query *)new_Xapian_Query__SWIG_8(arg1,(std::vector<Xapian::Query > const &)*arg2);DATA_PTR(self) = result;
...
_wrap_new_Query__SWIG_11(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::Query *)new Xapian::Query(arg1,arg2,arg3);DATA_PTR(self) = result;
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "Query.new", 
    "    Query.new(std::string const &tname, Xapian::termcount wqf, Xapian::termpos term_pos)\n"
    "    Query.new(std::string const &tname, Xapian::termcount wqf)\n"
    "    Query.new(std::string const &tname)\n"
    ...
    "    Query.new(Xapian::Query::op op_, Xapian::valueno valno, std::string const &begin, std::string const &end)\n"
    "    Query.new(Xapian::Query::op op_, Xapian::valueno valno, std::string const &value)\n"
    ...
    "    Query.new(Xapian::Query::op op_, Xapian::Query q)\n"
...
swig_class cValueRangeProcessor;
...
swig_class cStringValueRangeProcessor;
...
SWIGINTERN VALUE
_wrap_new_StringValueRangeProcessor(int argc, VALUE *argv, VALUE self) {
  Xapian::valueno arg1 ;
  ...
  {
    try {
      result = (Xapian::StringValueRangeProcessor *)new Xapian::StringValueRangeProcessor(arg1);DATA_PTR(self) = result;
...
swig_class cDateValueRangeProcessor;
...
_wrap_new_DateValueRangeProcessor__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::DateValueRangeProcessor *)new Xapian::DateValueRangeProcessor(arg1,arg2,arg3);DATA_PTR(self) = result;
...
_wrap_new_DateValueRangeProcessor__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::DateValueRangeProcessor *)new Xapian::DateValueRangeProcessor(arg1,arg2);DATA_PTR(self) = result;
...
_wrap_new_DateValueRangeProcessor__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::DateValueRangeProcessor *)new Xapian::DateValueRangeProcessor(arg1);DATA_PTR(self) = result;
...
fail:
  Ruby_Format_OverloadedError( argc, 3, "DateValueRangeProcessor.new", 
    "    DateValueRangeProcessor.new(Xapian::valueno valno_, bool prefer_mdy_, int epoch_year_)\n"
    "    DateValueRangeProcessor.new(Xapian::valueno valno_, bool prefer_mdy_)\n"
    "    DateValueRangeProcessor.new(Xapian::valueno valno_)\n");
...
swig_class cNumberValueRangeProcessor;
...
_wrap_new_NumberValueRangeProcessor__SWIG_0(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_unsigned_SS_int(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "Xapian::valueno","Xapian::v102::NumberValueRangeProcessor", 1, argv[0] ));
  } 
  arg1 = static_cast< Xapian::valueno >(val1);
  {
    try {
      result = (Xapian::v102::NumberValueRangeProcessor *)new Xapian::v102::NumberValueRangeProcessor(arg1);DATA_PTR(self) = result;
...
_wrap_new_NumberValueRangeProcessor__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = static_cast< Xapian::valueno >(val1);
  {
    ...
    res2 = SWIG_AsPtr_std_string(argv[1], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::string const &","Xapian::v102::NumberValueRangeProcessor", 2, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::string const &","Xapian::v102::NumberValueRangeProcessor", 2, argv[1])); 
    }
    arg2 = ptr;
  }
  ecode3 = SWIG_AsVal_bool(argv[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), Ruby_Format_TypeError( "", "bool","Xapian::v102::NumberValueRangeProcessor", 3, argv[2] ));
  } 
  arg3 = static_cast< bool >(val3);
  {
    try {
      result = (Xapian::v102::NumberValueRangeProcessor *)new Xapian::v102::NumberValueRangeProcessor(arg1,(std::string const &)*arg2,arg3);DATA_PTR(self) = result;
...
_wrap_NumberValueRangeProcessor_allocate(VALUE self) {
  ...
  _wrap_NumberValueRangeProcessor_allocate(int argc, VALUE *argv, VALUE self) {
    ...
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_Xapian__v102__NumberValueRangeProcessor);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
_wrap_new_NumberValueRangeProcessor__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::v102::NumberValueRangeProcessor *)new Xapian::v102::NumberValueRangeProcessor(arg1,(std::string const &)*arg2);DATA_PTR(self) = result;
...
fail:
  Ruby_Format_OverloadedError( argc, 3, "NumberValueRangeProcessor.new", 
    "    NumberValueRangeProcessor.new(Xapian::valueno valno_)\n"
    "    NumberValueRangeProcessor.new(Xapian::valueno valno_, std::string const &str_, bool prefix_)\n"
    "    NumberValueRangeProcessor.new(Xapian::valueno valno_, std::string const &str_)\n");
...
_wrap_NumberValueRangeProcessor___call__(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__v102__NumberValueRangeProcessor, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::v102::NumberValueRangeProcessor *","operator ()", 1, self )); 
  }
...
SWIGINTERN void
free_Xapian_v102_NumberValueRangeProcessor(Xapian::v102::NumberValueRangeProcessor *arg1) {
    delete arg1;
}
...
SWIGINTERN VALUE
_wrap_QueryParser_add_boolean_prefix(int argc, VALUE *argv, VALUE self) {
  Xapian::QueryParser *arg1 = (Xapian::QueryParser *) 0 ;
  std::string *arg2 = 0 ;
  std::string *arg3 = 0 ;
  void *argp1 = 0 ;
...
SWIGINTERN VALUE
_wrap_new_Stem(int argc, VALUE *argv, VALUE self) {
  std::string *arg1 = 0 ;
  ...
  {
    try {
      result = (Xapian::Stem *)new Xapian::Stem((std::string const &)*arg1);DATA_PTR(self) = result;
...
_wrap_new_TermGenerator(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::TermGenerator *)new Xapian::TermGenerator();DATA_PTR(self) = result;
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "TermGenerator.index_text", 
    "    void TermGenerator.index_text(std::string const &text, Xapian::termcount weight, std::string const &prefix)\n"
    "    void TermGenerator.index_text(std::string const &text, Xapian::termcount weight)\n"
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "TermGenerator.index_text_without_positions", 
    "    void TermGenerator.index_text_without_positions(std::string const &text, Xapian::termcount weight, std::string const &prefix)\n"
    "    void TermGenerator.index_text_without_positions(std::string const &text, Xapian::termcount weight)\n"
...
SWIGINTERN VALUE
_wrap_Sorter___call__(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_Xapian__Sorter, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::Sorter const *","operator ()", 1, self )); 
  }
...
#ifdef HAVE_RB_DEFINE_ALLOC_FUNC
SWIGINTERN VALUE
_wrap_Sorter_allocate(VALUE self) {
#else
  SWIGINTERN VALUE
  _wrap_Sorter_allocate(int argc, VALUE *argv, VALUE self) {
#endif
    
    
    VALUE vresult = SWIG_NewClassInstance(self, SWIGTYPE_p_Xapian__Sorter);
#ifndef HAVE_RB_DEFINE_ALLOC_FUNC
    rb_obj_call_init(vresult, argc, argv);
#endif
    return vresult;
...
SWIGINTERN VALUE
_wrap_new_Sorter(int argc, VALUE *argv, VALUE self) {
  VALUE arg1 = (VALUE) 0 ;
  Xapian::Sorter *result = 0 ;
  const char *classname SWIGUNUSED = "Xapian::Sorter";
...
SWIGINTERN VALUE
_wrap_disown_Sorter(int argc, VALUE *argv, VALUE self) {
  Xapian::Sorter *arg1 = (Xapian::Sorter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_Xapian__Sorter, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "Xapian::Sorter *","disown_Sorter", 1, argv[0] )); 
  }
  arg1 = reinterpret_cast< Xapian::Sorter * >(argp1);
  {
    Swig::Director *director = dynamic_cast<Swig::Director *>(arg1);
...
_wrap_new_MultiValueSorter(int argc, VALUE *argv, VALUE self) {
  ...
  {
    try {
      result = (Xapian::MultiValueSorter *)new Xapian::MultiValueSorter();DATA_PTR(self) = result;
...
fail:
  Ruby_Format_OverloadedError( argc, 4, "MultiValueSorter.add", 
    "    void MultiValueSorter.add(Xapian::valueno valno, bool forward)\n"
    "    void MultiValueSorter.add(Xapian::valueno valno)\n");
...
SWIGEXPORT void Init__xapian(void) {
  ...
  cGC_VALUE.klass = rb_define_class_under(mXapian, "GC_VALUE", rb_cObject);
  ...
  cConstIterator.klass = rb_define_class_under(mXapian, "ConstIterator", rb_cObject);
  ...
  cIterator.klass = rb_define_class_under(mXapian, "Iterator", ((swig_class *) SWIGTYPE_p_swig__ConstIterator->clientdata)->klass);
  ...
  cPositionIterator.klass = rb_define_class_under(mXapian, "PositionIterator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__PositionIterator, (void *) &cPositionIterator);
  rb_define_alloc_func(cPositionIterator.klass, _wrap_PositionIterator_allocate);
  rb_define_method(cPositionIterator.klass, "initialize", VALUEFUNC(_wrap_new_PositionIterator), -1);
  rb_define_method(cPositionIterator.klass, "termpos", VALUEFUNC(_wrap_PositionIterator_termpos), -1);
  rb_define_method(cPositionIterator.klass, "next", VALUEFUNC(_wrap_PositionIterator_next), -1);
  rb_define_method(cPositionIterator.klass, "equals", VALUEFUNC(_wrap_PositionIterator_equals), -1);
  rb_define_method(cPositionIterator.klass, "skip_to", VALUEFUNC(_wrap_PositionIterator_skip_to), -1);
  rb_define_method(cPositionIterator.klass, "description", VALUEFUNC(_wrap_PositionIterator_description), -1);
  cPositionIterator.mark = 0;
  cPositionIterator.destroy = (void (*)(void *)) free_Xapian_PositionIterator;
  cPositionIterator.trackObjects = 0;
  
  cPostingIterator.klass = rb_define_class_under(mXapian, "PostingIterator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__PostingIterator, (void *) &cPostingIterator);
  rb_define_alloc_func(cPostingIterator.klass, _wrap_PostingIterator_allocate);
  rb_define_method(cPostingIterator.klass, "initialize", VALUEFUNC(_wrap_new_PostingIterator), -1);
  rb_define_method(cPostingIterator.klass, "skip_to", VALUEFUNC(_wrap_PostingIterator_skip_to), -1);
  rb_define_method(cPostingIterator.klass, "doclength", VALUEFUNC(_wrap_PostingIterator_doclength), -1);
  rb_define_method(cPostingIterator.klass, "wdf", VALUEFUNC(_wrap_PostingIterator_wdf), -1);
  rb_define_method(cPostingIterator.klass, "_dangerous_positionlist_begin", VALUEFUNC(_wrap_PostingIterator__dangerous_positionlist_begin), -1);
  rb_define_method(cPostingIterator.klass, "_dangerous_positionlist_end", VALUEFUNC(_wrap_PostingIterator__dangerous_positionlist_end), -1);
  rb_define_method(cPostingIterator.klass, "description", VALUEFUNC(_wrap_PostingIterator_description), -1);
  rb_define_method(cPostingIterator.klass, "docid", VALUEFUNC(_wrap_PostingIterator_docid), -1);
  rb_define_method(cPostingIterator.klass, "next", VALUEFUNC(_wrap_PostingIterator_next), -1);
  rb_define_method(cPostingIterator.klass, "equals", VALUEFUNC(_wrap_PostingIterator_equals), -1);
  cPostingIterator.mark = 0;
  cPostingIterator.destroy = (void (*)(void *)) free_Xapian_PostingIterator;
  cPostingIterator.trackObjects = 0;
  rb_define_module_function(mXapian, "==", VALUEFUNC(_wrap___eq__), -1);
  
  cTermIterator.klass = rb_define_class_under(mXapian, "TermIterator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__TermIterator, (void *) &cTermIterator);
  rb_define_alloc_func(cTermIterator.klass, _wrap_TermIterator_allocate);
  rb_define_method(cTermIterator.klass, "initialize", VALUEFUNC(_wrap_new_TermIterator), -1);
  rb_define_method(cTermIterator.klass, "term", VALUEFUNC(_wrap_TermIterator_term), -1);
  rb_define_method(cTermIterator.klass, "next", VALUEFUNC(_wrap_TermIterator_next), -1);
  rb_define_method(cTermIterator.klass, "equals", VALUEFUNC(_wrap_TermIterator_equals), -1);
  rb_define_method(cTermIterator.klass, "skip_to", VALUEFUNC(_wrap_TermIterator_skip_to), -1);
  rb_define_method(cTermIterator.klass, "wdf", VALUEFUNC(_wrap_TermIterator_wdf), -1);
  rb_define_method(cTermIterator.klass, "termfreq", VALUEFUNC(_wrap_TermIterator_termfreq), -1);
  rb_define_method(cTermIterator.klass, "_dangerous_positionlist_begin", VALUEFUNC(_wrap_TermIterator__dangerous_positionlist_begin), -1);
  rb_define_method(cTermIterator.klass, "_dangerous_positionlist_end", VALUEFUNC(_wrap_TermIterator__dangerous_positionlist_end), -1);
  rb_define_method(cTermIterator.klass, "description", VALUEFUNC(_wrap_TermIterator_description), -1);
  cTermIterator.mark = 0;
  cTermIterator.destroy = (void (*)(void *)) free_Xapian_TermIterator;
  cTermIterator.trackObjects = 0;
  
  cValueIterator.klass = rb_define_class_under(mXapian, "ValueIterator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__ValueIterator, (void *) &cValueIterator);
  rb_define_alloc_func(cValueIterator.klass, _wrap_ValueIterator_allocate);
  rb_define_method(cValueIterator.klass, "initialize", VALUEFUNC(_wrap_new_ValueIterator), -1);
  rb_define_method(cValueIterator.klass, "value", VALUEFUNC(_wrap_ValueIterator_value), -1);
  rb_define_method(cValueIterator.klass, "next", VALUEFUNC(_wrap_ValueIterator_next), -1);
  rb_define_method(cValueIterator.klass, "equals", VALUEFUNC(_wrap_ValueIterator_equals), -1);
  rb_define_method(cValueIterator.klass, "valueno", VALUEFUNC(_wrap_ValueIterator_valueno), -1);
  rb_define_method(cValueIterator.klass, "description", VALUEFUNC(_wrap_ValueIterator_description), -1);
  cValueIterator.mark = 0;
  cValueIterator.destroy = (void (*)(void *)) free_Xapian_ValueIterator;
  cValueIterator.trackObjects = 0;
  
  cDocument.klass = rb_define_class_under(mXapian, "Document", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Document, (void *) &cDocument);
  ...
  rb_define_method(cDocument.klass, "value", VALUEFUNC(_wrap_Document_value), -1);
  rb_define_method(cDocument.klass, "add_value", VALUEFUNC(_wrap_Document_add_value), -1);
  rb_define_method(cDocument.klass, "remove_value", VALUEFUNC(_wrap_Document_remove_value), -1);
  rb_define_method(cDocument.klass, "clear_values", VALUEFUNC(_wrap_Document_clear_values), -1);
  rb_define_method(cDocument.klass, "data", VALUEFUNC(_wrap_Document_data), -1);
  rb_define_method(cDocument.klass, "data=", VALUEFUNC(_wrap_Document_datae___), -1);
  rb_define_method(cDocument.klass, "add_posting", VALUEFUNC(_wrap_Document_add_posting), -1);
  rb_define_method(cDocument.klass, "add_term", VALUEFUNC(_wrap_Document_add_term), -1);
  rb_define_method(cDocument.klass, "remove_posting", VALUEFUNC(_wrap_Document_remove_posting), -1);
  rb_define_method(cDocument.klass, "remove_term", VALUEFUNC(_wrap_Document_remove_term), -1);
  rb_define_method(cDocument.klass, "clear_terms", VALUEFUNC(_wrap_Document_clear_terms), -1);
  rb_define_method(cDocument.klass, "termlist_count", VALUEFUNC(_wrap_Document_termlist_count), -1);
  rb_define_method(cDocument.klass, "_dangerous_termlist_begin", VALUEFUNC(_wrap_Document__dangerous_termlist_begin), -1);
  rb_define_method(cDocument.klass, "_dangerous_termlist_end", VALUEFUNC(_wrap_Document__dangerous_termlist_end), -1);
  rb_define_method(cDocument.klass, "values_count", VALUEFUNC(_wrap_Document_values_count), -1);
  rb_define_method(cDocument.klass, "_dangerous_values_begin", VALUEFUNC(_wrap_Document__dangerous_values_begin), -1);
  rb_define_method(cDocument.klass, "_dangerous_values_end", VALUEFUNC(_wrap_Document__dangerous_values_end), -1);
  rb_define_method(cDocument.klass, "docid", VALUEFUNC(_wrap_Document_docid), -1);
  rb_define_method(cDocument.klass, "description", VALUEFUNC(_wrap_Document_description), -1);
  cDocument.mark = 0;
  cDocument.destroy = (void (*)(void *)) free_Xapian_Document;
  cDocument.trackObjects = 0;
  
  cMSet.klass = rb_define_class_under(mXapian, "MSet", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__MSet, (void *) &cMSet);
  rb_define_alloc_func(cMSet.klass, _wrap_MSet_allocate);
  rb_define_method(cMSet.klass, "initialize", VALUEFUNC(_wrap_new_MSet), -1);
  rb_define_method(cMSet.klass, "fetch", VALUEFUNC(_wrap_MSet_fetch), -1);
  rb_define_method(cMSet.klass, "convert_to_percent", VALUEFUNC(_wrap_MSet_convert_to_percent), -1);
  rb_define_method(cMSet.klass, "termfreq", VALUEFUNC(_wrap_MSet_termfreq), -1);
  rb_define_method(cMSet.klass, "termweight", VALUEFUNC(_wrap_MSet_termweight), -1);
  rb_define_method(cMSet.klass, "firstitem", VALUEFUNC(_wrap_MSet_firstitem), -1);
  rb_define_method(cMSet.klass, "matches_lower_bound", VALUEFUNC(_wrap_MSet_matches_lower_bound), -1);
  rb_define_method(cMSet.klass, "matches_estimated", VALUEFUNC(_wrap_MSet_matches_estimated), -1);
  rb_define_method(cMSet.klass, "matches_upper_bound", VALUEFUNC(_wrap_MSet_matches_upper_bound), -1);
  rb_define_method(cMSet.klass, "max_possible", VALUEFUNC(_wrap_MSet_max_possible), -1);
  rb_define_method(cMSet.klass, "max_attained", VALUEFUNC(_wrap_MSet_max_attained), -1);
  rb_define_method(cMSet.klass, "size", VALUEFUNC(_wrap_MSet_size), -1);
  rb_define_method(cMSet.klass, "empty?", VALUEFUNC(_wrap_MSet_emptyq___), -1);
  rb_define_method(cMSet.klass, "_begin", VALUEFUNC(_wrap_MSet__begin), -1);
  rb_define_method(cMSet.klass, "_end", VALUEFUNC(_wrap_MSet__end), -1);
  rb_define_method(cMSet.klass, "_back", VALUEFUNC(_wrap_MSet__back), -1);
  rb_define_method(cMSet.klass, "hit", VALUEFUNC(_wrap_MSet_hit), -1);
  rb_define_method(cMSet.klass, "document_percentage", VALUEFUNC(_wrap_MSet_document_percentage), -1);
  rb_define_method(cMSet.klass, "document", VALUEFUNC(_wrap_MSet_document), -1);
  rb_define_method(cMSet.klass, "docid", VALUEFUNC(_wrap_MSet_docid), -1);
  rb_define_method(cMSet.klass, "description", VALUEFUNC(_wrap_MSet_description), -1);
  cMSet.mark = 0;
  cMSet.destroy = (void (*)(void *)) free_Xapian_MSet;
  cMSet.trackObjects = 0;
  
  cMSetIterator.klass = rb_define_class_under(mXapian, "MSetIterator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__MSetIterator, (void *) &cMSetIterator);
  rb_define_alloc_func(cMSetIterator.klass, _wrap_MSetIterator_allocate);
  rb_define_method(cMSetIterator.klass, "initialize", VALUEFUNC(_wrap_new_MSetIterator), -1);
  rb_define_method(cMSetIterator.klass, "docid", VALUEFUNC(_wrap_MSetIterator_docid), -1);
  rb_define_method(cMSetIterator.klass, "next", VALUEFUNC(_wrap_MSetIterator_next), -1);
  rb_define_method(cMSetIterator.klass, "prev", VALUEFUNC(_wrap_MSetIterator_prev), -1);
  rb_define_method(cMSetIterator.klass, "equals", VALUEFUNC(_wrap_MSetIterator_equals), -1);
  rb_define_method(cMSetIterator.klass, "document", VALUEFUNC(_wrap_MSetIterator_document), -1);
  rb_define_method(cMSetIterator.klass, "rank", VALUEFUNC(_wrap_MSetIterator_rank), -1);
  rb_define_method(cMSetIterator.klass, "weight", VALUEFUNC(_wrap_MSetIterator_weight), -1);
  rb_define_method(cMSetIterator.klass, "get_collapse_key", VALUEFUNC(_wrap_MSetIterator_get_collapse_key), -1);
  rb_define_method(cMSetIterator.klass, "collapse_count", VALUEFUNC(_wrap_MSetIterator_collapse_count), -1);
  rb_define_method(cMSetIterator.klass, "percent", VALUEFUNC(_wrap_MSetIterator_percent), -1);
  rb_define_method(cMSetIterator.klass, "description", VALUEFUNC(_wrap_MSetIterator_description), -1);
  cMSetIterator.mark = 0;
  cMSetIterator.destroy = (void (*)(void *)) free_Xapian_MSetIterator;
  cMSetIterator.trackObjects = 0;
  
  cESet.klass = rb_define_class_under(mXapian, "ESet", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__ESet, (void *) &cESet);
  rb_define_alloc_func(cESet.klass, _wrap_ESet_allocate);
  rb_define_method(cESet.klass, "initialize", VALUEFUNC(_wrap_new_ESet), -1);
  rb_define_method(cESet.klass, "ebound", VALUEFUNC(_wrap_ESet_ebound), -1);
  rb_define_method(cESet.klass, "size", VALUEFUNC(_wrap_ESet_size), -1);
  rb_define_method(cESet.klass, "empty?", VALUEFUNC(_wrap_ESet_emptyq___), -1);
  rb_define_method(cESet.klass, "_begin", VALUEFUNC(_wrap_ESet__begin), -1);
  rb_define_method(cESet.klass, "_end", VALUEFUNC(_wrap_ESet__end), -1);
  rb_define_method(cESet.klass, "_back", VALUEFUNC(_wrap_ESet__back), -1);
  rb_define_method(cESet.klass, "description", VALUEFUNC(_wrap_ESet_description), -1);
  cESet.mark = 0;
  cESet.destroy = (void (*)(void *)) free_Xapian_ESet;
  cESet.trackObjects = 0;
  
  cESetIterator.klass = rb_define_class_under(mXapian, "ESetIterator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__ESetIterator, (void *) &cESetIterator);
  rb_define_alloc_func(cESetIterator.klass, _wrap_ESetIterator_allocate);
  rb_define_method(cESetIterator.klass, "initialize", VALUEFUNC(_wrap_new_ESetIterator), -1);
  rb_define_method(cESetIterator.klass, "termname", VALUEFUNC(_wrap_ESetIterator_termname), -1);
  rb_define_method(cESetIterator.klass, "term", VALUEFUNC(_wrap_ESetIterator_term), -1);
  rb_define_method(cESetIterator.klass, "next", VALUEFUNC(_wrap_ESetIterator_next), -1);
  rb_define_method(cESetIterator.klass, "prev", VALUEFUNC(_wrap_ESetIterator_prev), -1);
  rb_define_method(cESetIterator.klass, "equals", VALUEFUNC(_wrap_ESetIterator_equals), -1);
  rb_define_method(cESetIterator.klass, "weight", VALUEFUNC(_wrap_ESetIterator_weight), -1);
  rb_define_method(cESetIterator.klass, "description", VALUEFUNC(_wrap_ESetIterator_description), -1);
  cESetIterator.mark = 0;
  cESetIterator.destroy = (void (*)(void *)) free_Xapian_ESetIterator;
  cESetIterator.trackObjects = 0;
  
  cRSet.klass = rb_define_class_under(mXapian, "RSet", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__RSet, (void *) &cRSet);
  rb_define_alloc_func(cRSet.klass, _wrap_RSet_allocate);
  rb_define_method(cRSet.klass, "initialize", VALUEFUNC(_wrap_new_RSet), -1);
  rb_define_method(cRSet.klass, "size", VALUEFUNC(_wrap_RSet_size), -1);
  rb_define_method(cRSet.klass, "empty?", VALUEFUNC(_wrap_RSet_emptyq___), -1);
  rb_define_method(cRSet.klass, "add_document", VALUEFUNC(_wrap_RSet_add_document), -1);
  rb_define_method(cRSet.klass, "remove_document", VALUEFUNC(_wrap_RSet_remove_document), -1);
  rb_define_method(cRSet.klass, "contains", VALUEFUNC(_wrap_RSet_contains), -1);
  rb_define_method(cRSet.klass, "description", VALUEFUNC(_wrap_RSet_description), -1);
  cRSet.mark = 0;
  cRSet.destroy = (void (*)(void *)) free_Xapian_RSet;
  cRSet.trackObjects = 0;
  rb_define_module_function(mXapian, "disown_MatchDecider", VALUEFUNC(_wrap_disown_MatchDecider), -1);
  
  cMatchDecider.klass = rb_define_class_under(mXapian, "MatchDecider", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__MatchDecider, (void *) &cMatchDecider);
  rb_define_alloc_func(cMatchDecider.klass, _wrap_MatchDecider_allocate);
  rb_define_method(cMatchDecider.klass, "initialize", VALUEFUNC(_wrap_new_MatchDecider), -1);
  rb_define_method(cMatchDecider.klass, "call", VALUEFUNC(_wrap_MatchDecider___call__), -1);
  cMatchDecider.mark = 0;
  cMatchDecider.destroy = (void (*)(void *)) free_Xapian_MatchDecider;
  cMatchDecider.trackObjects = 0;
  rb_define_module_function(mXapian, "disown_ExpandDecider", VALUEFUNC(_wrap_disown_ExpandDecider), -1);
  
  cExpandDecider.klass = rb_define_class_under(mXapian, "ExpandDecider", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__ExpandDecider, (void *) &cExpandDecider);
  rb_define_alloc_func(cExpandDecider.klass, _wrap_ExpandDecider_allocate);
  rb_define_method(cExpandDecider.klass, "initialize", VALUEFUNC(_wrap_new_ExpandDecider), -1);
  rb_define_method(cExpandDecider.klass, "call", VALUEFUNC(_wrap_ExpandDecider___call__), -1);
  cExpandDecider.mark = 0;
  cExpandDecider.destroy = (void (*)(void *)) free_Xapian_ExpandDecider;
  cExpandDecider.trackObjects = 0;
  
  cEnquire.klass = rb_define_class_under(mXapian, "Enquire", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Enquire, (void *) &cEnquire);
  rb_define_alloc_func(cEnquire.klass, _wrap_Enquire_allocate);
  rb_define_method(cEnquire.klass, "initialize", VALUEFUNC(_wrap_new_Enquire), -1);
  rb_define_method(cEnquire.klass, "query!", VALUEFUNC(_wrap_Enquire_queryN___), -1);
  rb_define_method(cEnquire.klass, "query=", VALUEFUNC(_wrap_Enquire_querye___), -1);
  rb_define_method(cEnquire.klass, "query", VALUEFUNC(_wrap_Enquire_query), -1);
  rb_define_method(cEnquire.klass, "weighting_scheme=", VALUEFUNC(_wrap_Enquire_weighting_schemee___), -1);
  rb_define_method(cEnquire.klass, "collapse_key=", VALUEFUNC(_wrap_Enquire_collapse_keye___), -1);
  rb_define_const(cEnquire.klass, "ASCENDING", SWIG_From_int(static_cast< int >(Xapian::Enquire::ASCENDING)));
  rb_define_const(cEnquire.klass, "DESCENDING", SWIG_From_int(static_cast< int >(Xapian::Enquire::DESCENDING)));
  rb_define_const(cEnquire.klass, "DONT_CARE", SWIG_From_int(static_cast< int >(Xapian::Enquire::DONT_CARE)));
  rb_define_method(cEnquire.klass, "docid_order=", VALUEFUNC(_wrap_Enquire_docid_ordere___), -1);
  rb_define_method(cEnquire.klass, "cutoff!", VALUEFUNC(_wrap_Enquire_cutoffN___), -1);
  rb_define_method(cEnquire.klass, "sort_by_relevance!", VALUEFUNC(_wrap_Enquire_sort_by_relevanceN___), -1);
  rb_define_method(cEnquire.klass, "sort_by_value!", VALUEFUNC(_wrap_Enquire_sort_by_valueN___), -1);
  rb_define_method(cEnquire.klass, "sort_by_value_then_relevance!", VALUEFUNC(_wrap_Enquire_sort_by_value_then_relevanceN___), -1);
  rb_define_method(cEnquire.klass, "sort_by_relevance_then_value!", VALUEFUNC(_wrap_Enquire_sort_by_relevance_then_valueN___), -1);
  rb_define_method(cEnquire.klass, "set_sort_by_key", VALUEFUNC(_wrap_Enquire_set_sort_by_key), -1);
  rb_define_method(cEnquire.klass, "set_sort_by_key_then_relevance", VALUEFUNC(_wrap_Enquire_set_sort_by_key_then_relevance), -1);
  rb_define_method(cEnquire.klass, "set_sort_by_relevance_then_key", VALUEFUNC(_wrap_Enquire_set_sort_by_relevance_then_key), -1);
  rb_define_const(cEnquire.klass, "INCLUDE_QUERY_TERMS", SWIG_From_int(static_cast< int >(Xapian::Enquire::INCLUDE_QUERY_TERMS)));
  rb_define_const(cEnquire.klass, "USE_EXACT_TERMFREQ", SWIG_From_int(static_cast< int >(Xapian::Enquire::USE_EXACT_TERMFREQ)));
  rb_define_method(cEnquire.klass, "mset", VALUEFUNC(_wrap_Enquire_mset), -1);
  rb_define_method(cEnquire.klass, "eset", VALUEFUNC(_wrap_Enquire_eset), -1);
  rb_define_method(cEnquire.klass, "_dangerous_matching_terms_begin", VALUEFUNC(_wrap_Enquire__dangerous_matching_terms_begin), -1);
  rb_define_method(cEnquire.klass, "_dangerous_matching_terms_end", VALUEFUNC(_wrap_Enquire__dangerous_matching_terms_end), -1);
  rb_define_method(cEnquire.klass, "register_match_decider", VALUEFUNC(_wrap_Enquire_register_match_decider), -1);
  rb_define_method(cEnquire.klass, "description", VALUEFUNC(_wrap_Enquire_description), -1);
  cEnquire.mark = 0;
  cEnquire.destroy = (void (*)(void *)) free_Xapian_Enquire;
  cEnquire.trackObjects = 0;
  
  cWeight.klass = rb_define_class_under(mXapian, "Weight", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Weight, (void *) &cWeight);
  rb_undef_alloc_func(cWeight.klass);
  rb_define_method(cWeight.klass, "name", VALUEFUNC(_wrap_Weight_name), -1);
  rb_define_method(cWeight.klass, "serialise", VALUEFUNC(_wrap_Weight_serialise), -1);
  rb_define_method(cWeight.klass, "unserialise", VALUEFUNC(_wrap_Weight_unserialise), -1);
  rb_define_method(cWeight.klass, "sumpart", VALUEFUNC(_wrap_Weight_sumpart), -1);
  rb_define_method(cWeight.klass, "maxpart", VALUEFUNC(_wrap_Weight_maxpart), -1);
  rb_define_method(cWeight.klass, "sumextra", VALUEFUNC(_wrap_Weight_sumextra), -1);
  rb_define_method(cWeight.klass, "maxextra", VALUEFUNC(_wrap_Weight_maxextra), -1);
  rb_define_method(cWeight.klass, "sumpart_needs_doclength", VALUEFUNC(_wrap_Weight_sumpart_needs_doclength), -1);
  cWeight.mark = 0;
  cWeight.destroy = (void (*)(void *)) free_Xapian_Weight;
  cWeight.trackObjects = 0;
  
  cBoolWeight.klass = rb_define_class_under(mXapian, "BoolWeight", ((swig_class *) SWIGTYPE_p_Xapian__Weight->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__BoolWeight, (void *) &cBoolWeight);
  rb_define_alloc_func(cBoolWeight.klass, _wrap_BoolWeight_allocate);
  rb_define_method(cBoolWeight.klass, "initialize", VALUEFUNC(_wrap_new_BoolWeight), -1);
  rb_define_method(cBoolWeight.klass, "clone", VALUEFUNC(_wrap_BoolWeight_clone), -1);
  rb_define_method(cBoolWeight.klass, "name", VALUEFUNC(_wrap_BoolWeight_name), -1);
  rb_define_method(cBoolWeight.klass, "serialise", VALUEFUNC(_wrap_BoolWeight_serialise), -1);
  rb_define_method(cBoolWeight.klass, "unserialise", VALUEFUNC(_wrap_BoolWeight_unserialise), -1);
  rb_define_method(cBoolWeight.klass, "sumpart", VALUEFUNC(_wrap_BoolWeight_sumpart), -1);
  rb_define_method(cBoolWeight.klass, "maxpart", VALUEFUNC(_wrap_BoolWeight_maxpart), -1);
  rb_define_method(cBoolWeight.klass, "sumextra", VALUEFUNC(_wrap_BoolWeight_sumextra), -1);
  rb_define_method(cBoolWeight.klass, "maxextra", VALUEFUNC(_wrap_BoolWeight_maxextra), -1);
  rb_define_method(cBoolWeight.klass, "sumpart_needs_doclength", VALUEFUNC(_wrap_BoolWeight_sumpart_needs_doclength), -1);
  cBoolWeight.mark = 0;
  cBoolWeight.destroy = (void (*)(void *)) free_Xapian_BoolWeight;
  cBoolWeight.trackObjects = 0;
  
  cBM25Weight.klass = rb_define_class_under(mXapian, "BM25Weight", ((swig_class *) SWIGTYPE_p_Xapian__Weight->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__BM25Weight, (void *) &cBM25Weight);
  rb_define_alloc_func(cBM25Weight.klass, _wrap_BM25Weight_allocate);
  rb_define_method(cBM25Weight.klass, "initialize", VALUEFUNC(_wrap_new_BM25Weight), -1);
  rb_define_method(cBM25Weight.klass, "clone", VALUEFUNC(_wrap_BM25Weight_clone), -1);
  rb_define_method(cBM25Weight.klass, "name", VALUEFUNC(_wrap_BM25Weight_name), -1);
  rb_define_method(cBM25Weight.klass, "serialise", VALUEFUNC(_wrap_BM25Weight_serialise), -1);
  rb_define_method(cBM25Weight.klass, "unserialise", VALUEFUNC(_wrap_BM25Weight_unserialise), -1);
  rb_define_method(cBM25Weight.klass, "sumpart", VALUEFUNC(_wrap_BM25Weight_sumpart), -1);
  rb_define_method(cBM25Weight.klass, "maxpart", VALUEFUNC(_wrap_BM25Weight_maxpart), -1);
  rb_define_method(cBM25Weight.klass, "sumextra", VALUEFUNC(_wrap_BM25Weight_sumextra), -1);
  rb_define_method(cBM25Weight.klass, "maxextra", VALUEFUNC(_wrap_BM25Weight_maxextra), -1);
  rb_define_method(cBM25Weight.klass, "sumpart_needs_doclength", VALUEFUNC(_wrap_BM25Weight_sumpart_needs_doclength), -1);
  cBM25Weight.mark = 0;
  cBM25Weight.destroy = (void (*)(void *)) free_Xapian_BM25Weight;
  cBM25Weight.trackObjects = 0;
  
  cTradWeight.klass = rb_define_class_under(mXapian, "TradWeight", ((swig_class *) SWIGTYPE_p_Xapian__Weight->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__TradWeight, (void *) &cTradWeight);
  rb_define_alloc_func(cTradWeight.klass, _wrap_TradWeight_allocate);
  rb_define_method(cTradWeight.klass, "initialize", VALUEFUNC(_wrap_new_TradWeight), -1);
  rb_define_method(cTradWeight.klass, "clone", VALUEFUNC(_wrap_TradWeight_clone), -1);
  rb_define_method(cTradWeight.klass, "name", VALUEFUNC(_wrap_TradWeight_name), -1);
  rb_define_method(cTradWeight.klass, "serialise", VALUEFUNC(_wrap_TradWeight_serialise), -1);
  rb_define_method(cTradWeight.klass, "unserialise", VALUEFUNC(_wrap_TradWeight_unserialise), -1);
  rb_define_method(cTradWeight.klass, "sumpart", VALUEFUNC(_wrap_TradWeight_sumpart), -1);
  rb_define_method(cTradWeight.klass, "maxpart", VALUEFUNC(_wrap_TradWeight_maxpart), -1);
  rb_define_method(cTradWeight.klass, "sumextra", VALUEFUNC(_wrap_TradWeight_sumextra), -1);
  rb_define_method(cTradWeight.klass, "maxextra", VALUEFUNC(_wrap_TradWeight_maxextra), -1);
  rb_define_method(cTradWeight.klass, "sumpart_needs_doclength", VALUEFUNC(_wrap_TradWeight_sumpart_needs_doclength), -1);
  cTradWeight.mark = 0;
  cTradWeight.destroy = (void (*)(void *)) free_Xapian_TradWeight;
  cTradWeight.trackObjects = 0;
  
  cDatabase.klass = rb_define_class_under(mXapian, "Database", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Database, (void *) &cDatabase);
  ...
  rb_define_method(cDatabase.klass, "add_database", VALUEFUNC(_wrap_Database_add_database), -1);
  rb_define_method(cDatabase.klass, "reopen", VALUEFUNC(_wrap_Database_reopen), -1);
  rb_define_method(cDatabase.klass, "description", VALUEFUNC(_wrap_Database_description), -1);
  rb_define_method(cDatabase.klass, "_dangerous_postlist_begin", VALUEFUNC(_wrap_Database__dangerous_postlist_begin), -1);
  rb_define_method(cDatabase.klass, "_dangerous_postlist_end", VALUEFUNC(_wrap_Database__dangerous_postlist_end), -1);
  rb_define_method(cDatabase.klass, "_dangerous_termlist_begin", VALUEFUNC(_wrap_Database__dangerous_termlist_begin), -1);
  rb_define_method(cDatabase.klass, "_dangerous_termlist_end", VALUEFUNC(_wrap_Database__dangerous_termlist_end), -1);
  rb_define_method(cDatabase.klass, "_dangerous_positionlist_begin", VALUEFUNC(_wrap_Database__dangerous_positionlist_begin), -1);
  rb_define_method(cDatabase.klass, "_dangerous_positionlist_end", VALUEFUNC(_wrap_Database__dangerous_positionlist_end), -1);
  rb_define_method(cDatabase.klass, "_dangerous_allterms_begin", VALUEFUNC(_wrap_Database__dangerous_allterms_begin), -1);
  rb_define_method(cDatabase.klass, "_dangerous_allterms_end", VALUEFUNC(_wrap_Database__dangerous_allterms_end), -1);
  rb_define_method(cDatabase.klass, "doccount", VALUEFUNC(_wrap_Database_doccount), -1);
  rb_define_method(cDatabase.klass, "lastdocid", VALUEFUNC(_wrap_Database_lastdocid), -1);
  rb_define_method(cDatabase.klass, "avlength", VALUEFUNC(_wrap_Database_avlength), -1);
  rb_define_method(cDatabase.klass, "termfreq", VALUEFUNC(_wrap_Database_termfreq), -1);
  rb_define_method(cDatabase.klass, "term_exists", VALUEFUNC(_wrap_Database_term_exists), -1);
  rb_define_method(cDatabase.klass, "collection_freq", VALUEFUNC(_wrap_Database_collection_freq), -1);
  rb_define_method(cDatabase.klass, "doclength", VALUEFUNC(_wrap_Database_doclength), -1);
  rb_define_method(cDatabase.klass, "keep_alive", VALUEFUNC(_wrap_Database_keep_alive), -1);
  rb_define_method(cDatabase.klass, "document", VALUEFUNC(_wrap_Database_document), -1);
  rb_define_method(cDatabase.klass, "get_spelling_suggestion", VALUEFUNC(_wrap_Database_get_spelling_suggestion), -1);
  rb_define_method(cDatabase.klass, "spellings_begin", VALUEFUNC(_wrap_Database_spellings_begin), -1);
  rb_define_method(cDatabase.klass, "spellings_end", VALUEFUNC(_wrap_Database_spellings_end), -1);
  rb_define_method(cDatabase.klass, "synonyms_begin", VALUEFUNC(_wrap_Database_synonyms_begin), -1);
  rb_define_method(cDatabase.klass, "synonyms_end", VALUEFUNC(_wrap_Database_synonyms_end), -1);
  rb_define_method(cDatabase.klass, "synonym_keys_begin", VALUEFUNC(_wrap_Database_synonym_keys_begin), -1);
  rb_define_method(cDatabase.klass, "synonym_keys_end", VALUEFUNC(_wrap_Database_synonym_keys_end), -1);
  rb_define_method(cDatabase.klass, "get_metadata", VALUEFUNC(_wrap_Database_get_metadata), -1);
  rb_define_method(cDatabase.klass, "metadata_keys_begin", VALUEFUNC(_wrap_Database_metadata_keys_begin), -1);
  rb_define_method(cDatabase.klass, "metadata_keys_end", VALUEFUNC(_wrap_Database_metadata_keys_end), -1);
  cDatabase.mark = 0;
  cDatabase.destroy = (void (*)(void *)) free_Xapian_Database;
  cDatabase.trackObjects = 0;
  
  cWritableDatabase.klass = rb_define_class_under(mXapian, "WritableDatabase", ((swig_class *) SWIGTYPE_p_Xapian__Database->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__WritableDatabase, (void *) &cWritableDatabase);
  rb_define_alloc_func(cWritableDatabase.klass, _wrap_WritableDatabase_allocate);
  rb_define_method(cWritableDatabase.klass, "initialize", VALUEFUNC(_wrap_new_WritableDatabase), -1);
  rb_define_method(cWritableDatabase.klass, "flush", VALUEFUNC(_wrap_WritableDatabase_flush), -1);
  rb_define_method(cWritableDatabase.klass, "begin_transaction", VALUEFUNC(_wrap_WritableDatabase_begin_transaction), -1);
  rb_define_method(cWritableDatabase.klass, "commit_transaction", VALUEFUNC(_wrap_WritableDatabase_commit_transaction), -1);
  rb_define_method(cWritableDatabase.klass, "cancel_transaction", VALUEFUNC(_wrap_WritableDatabase_cancel_transaction), -1);
  rb_define_method(cWritableDatabase.klass, "add_document", VALUEFUNC(_wrap_WritableDatabase_add_document), -1);
  rb_define_method(cWritableDatabase.klass, "delete_document", VALUEFUNC(_wrap_WritableDatabase_delete_document), -1);
  rb_define_method(cWritableDatabase.klass, "replace_document", VALUEFUNC(_wrap_WritableDatabase_replace_document), -1);
  rb_define_method(cWritableDatabase.klass, "add_spelling", VALUEFUNC(_wrap_WritableDatabase_add_spelling), -1);
  rb_define_method(cWritableDatabase.klass, "remove_spelling", VALUEFUNC(_wrap_WritableDatabase_remove_spelling), -1);
  rb_define_method(cWritableDatabase.klass, "add_synonym", VALUEFUNC(_wrap_WritableDatabase_add_synonym), -1);
  rb_define_method(cWritableDatabase.klass, "remove_synonym", VALUEFUNC(_wrap_WritableDatabase_remove_synonym), -1);
  rb_define_method(cWritableDatabase.klass, "clear_synonyms", VALUEFUNC(_wrap_WritableDatabase_clear_synonyms), -1);
  rb_define_method(cWritableDatabase.klass, "set_metadata", VALUEFUNC(_wrap_WritableDatabase_set_metadata), -1);
  rb_define_method(cWritableDatabase.klass, "description", VALUEFUNC(_wrap_WritableDatabase_description), -1);
  cWritableDatabase.mark = 0;
  cWritableDatabase.destroy = (void (*)(void *)) free_Xapian_WritableDatabase;
  cWritableDatabase.trackObjects = 0;
  ...
  rb_define_module_function(mXapian, "quartz_open", VALUEFUNC(_wrap_quartz_open), -1);
  ...
  cQuery.klass = rb_define_class_under(mXapian, "Query", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Query, (void *) &cQuery);
  rb_define_alloc_func(cQuery.klass, _wrap_Query_allocate);
  rb_define_method(cQuery.klass, "initialize", VALUEFUNC(_wrap_new_Query), -1);
  rb_define_const(cQuery.klass, "OP_AND", SWIG_From_int(static_cast< int >(Xapian::Query::OP_AND)));
  rb_define_const(cQuery.klass, "OP_OR", SWIG_From_int(static_cast< int >(Xapian::Query::OP_OR)));
  rb_define_const(cQuery.klass, "OP_AND_NOT", SWIG_From_int(static_cast< int >(Xapian::Query::OP_AND_NOT)));
  rb_define_const(cQuery.klass, "OP_XOR", SWIG_From_int(static_cast< int >(Xapian::Query::OP_XOR)));
  rb_define_const(cQuery.klass, "OP_AND_MAYBE", SWIG_From_int(static_cast< int >(Xapian::Query::OP_AND_MAYBE)));
  rb_define_const(cQuery.klass, "OP_FILTER", SWIG_From_int(static_cast< int >(Xapian::Query::OP_FILTER)));
  rb_define_const(cQuery.klass, "OP_NEAR", SWIG_From_int(static_cast< int >(Xapian::Query::OP_NEAR)));
  rb_define_const(cQuery.klass, "OP_PHRASE", SWIG_From_int(static_cast< int >(Xapian::Query::OP_PHRASE)));
  rb_define_const(cQuery.klass, "OP_VALUE_RANGE", SWIG_From_int(static_cast< int >(Xapian::Query::OP_VALUE_RANGE)));
  rb_define_const(cQuery.klass, "OP_SCALE_WEIGHT", SWIG_From_int(static_cast< int >(Xapian::Query::OP_SCALE_WEIGHT)));
  rb_define_const(cQuery.klass, "OP_ELITE_SET", SWIG_From_int(static_cast< int >(Xapian::Query::OP_ELITE_SET)));
  rb_define_const(cQuery.klass, "OP_VALUE_GE", SWIG_From_int(static_cast< int >(Xapian::Query::OP_VALUE_GE)));
  rb_define_const(cQuery.klass, "OP_VALUE_LE", SWIG_From_int(static_cast< int >(Xapian::Query::OP_VALUE_LE)));
  rb_define_method(cQuery.klass, "length", VALUEFUNC(_wrap_Query_length), -1);
  rb_define_method(cQuery.klass, "_dangerous_terms_begin", VALUEFUNC(_wrap_Query__dangerous_terms_begin), -1);
  rb_define_method(cQuery.klass, "_dangerous_terms_end", VALUEFUNC(_wrap_Query__dangerous_terms_end), -1);
  rb_define_method(cQuery.klass, "empty?", VALUEFUNC(_wrap_Query_emptyq___), -1);
  rb_define_method(cQuery.klass, "description", VALUEFUNC(_wrap_Query_description), -1);
  cQuery.mark = 0;
  cQuery.destroy = (void (*)(void *)) free_Xapian_Query;
  cQuery.trackObjects = 0;
  rb_define_module_function(mXapian, "disown_Stopper", VALUEFUNC(_wrap_disown_Stopper), -1);
  
  cStopper.klass = rb_define_class_under(mXapian, "Stopper", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Stopper, (void *) &cStopper);
  rb_define_alloc_func(cStopper.klass, _wrap_Stopper_allocate);
  rb_define_method(cStopper.klass, "initialize", VALUEFUNC(_wrap_new_Stopper), -1);
  rb_define_method(cStopper.klass, "call", VALUEFUNC(_wrap_Stopper___call__), -1);
  rb_define_method(cStopper.klass, "description", VALUEFUNC(_wrap_Stopper_description), -1);
  cStopper.mark = 0;
  cStopper.destroy = (void (*)(void *)) free_Xapian_Stopper;
  cStopper.trackObjects = 0;
  
  cSimpleStopper.klass = rb_define_class_under(mXapian, "SimpleStopper", ((swig_class *) SWIGTYPE_p_Xapian__Stopper->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__SimpleStopper, (void *) &cSimpleStopper);
  rb_define_alloc_func(cSimpleStopper.klass, _wrap_SimpleStopper_allocate);
  rb_define_method(cSimpleStopper.klass, "initialize", VALUEFUNC(_wrap_new_SimpleStopper), -1);
  rb_define_method(cSimpleStopper.klass, "add", VALUEFUNC(_wrap_SimpleStopper_add), -1);
  rb_define_method(cSimpleStopper.klass, "call", VALUEFUNC(_wrap_SimpleStopper___call__), -1);
  rb_define_method(cSimpleStopper.klass, "description", VALUEFUNC(_wrap_SimpleStopper_description), -1);
  cSimpleStopper.mark = 0;
  cSimpleStopper.destroy = (void (*)(void *)) free_Xapian_SimpleStopper;
  cSimpleStopper.trackObjects = 0;
  rb_define_module_function(mXapian, "disown_ValueRangeProcessor", VALUEFUNC(_wrap_disown_ValueRangeProcessor), -1);
  
  cValueRangeProcessor.klass = rb_define_class_under(mXapian, "ValueRangeProcessor", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__ValueRangeProcessor, (void *) &cValueRangeProcessor);
  rb_define_alloc_func(cValueRangeProcessor.klass, _wrap_ValueRangeProcessor_allocate);
  rb_define_method(cValueRangeProcessor.klass, "initialize", VALUEFUNC(_wrap_new_ValueRangeProcessor), -1);
  rb_define_method(cValueRangeProcessor.klass, "call", VALUEFUNC(_wrap_ValueRangeProcessor___call__), -1);
  cValueRangeProcessor.mark = 0;
  cValueRangeProcessor.destroy = (void (*)(void *)) free_Xapian_ValueRangeProcessor;
  cValueRangeProcessor.trackObjects = 0;
  
  cStringValueRangeProcessor.klass = rb_define_class_under(mXapian, "StringValueRangeProcessor", ((swig_class *) SWIGTYPE_p_Xapian__ValueRangeProcessor->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__StringValueRangeProcessor, (void *) &cStringValueRangeProcessor);
  rb_define_alloc_func(cStringValueRangeProcessor.klass, _wrap_StringValueRangeProcessor_allocate);
  rb_define_method(cStringValueRangeProcessor.klass, "initialize", VALUEFUNC(_wrap_new_StringValueRangeProcessor), -1);
  rb_define_method(cStringValueRangeProcessor.klass, "call", VALUEFUNC(_wrap_StringValueRangeProcessor___call__), -1);
  cStringValueRangeProcessor.mark = 0;
  cStringValueRangeProcessor.destroy = (void (*)(void *)) free_Xapian_StringValueRangeProcessor;
  cStringValueRangeProcessor.trackObjects = 0;
  
  cDateValueRangeProcessor.klass = rb_define_class_under(mXapian, "DateValueRangeProcessor", ((swig_class *) SWIGTYPE_p_Xapian__ValueRangeProcessor->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__DateValueRangeProcessor, (void *) &cDateValueRangeProcessor);
  rb_define_alloc_func(cDateValueRangeProcessor.klass, _wrap_DateValueRangeProcessor_allocate);
  rb_define_method(cDateValueRangeProcessor.klass, "initialize", VALUEFUNC(_wrap_new_DateValueRangeProcessor), -1);
  rb_define_method(cDateValueRangeProcessor.klass, "call", VALUEFUNC(_wrap_DateValueRangeProcessor___call__), -1);
  cDateValueRangeProcessor.mark = 0;
  cDateValueRangeProcessor.destroy = (void (*)(void *)) free_Xapian_DateValueRangeProcessor;
  cDateValueRangeProcessor.trackObjects = 0;
  
  cNumberValueRangeProcessor.klass = rb_define_class_under(mXapian, "NumberValueRangeProcessor", ((swig_class *) SWIGTYPE_p_Xapian__ValueRangeProcessor->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__v102__NumberValueRangeProcessor, (void *) &cNumberValueRangeProcessor);
  rb_define_alloc_func(cNumberValueRangeProcessor.klass, _wrap_NumberValueRangeProcessor_allocate);
  rb_define_method(cNumberValueRangeProcessor.klass, "initialize", VALUEFUNC(_wrap_new_NumberValueRangeProcessor), -1);
  rb_define_method(cNumberValueRangeProcessor.klass, "call", VALUEFUNC(_wrap_NumberValueRangeProcessor___call__), -1);
  cNumberValueRangeProcessor.mark = 0;
  cNumberValueRangeProcessor.destroy = (void (*)(void *)) free_Xapian_v102_NumberValueRangeProcessor;
  cNumberValueRangeProcessor.trackObjects = 0;
  
  cQueryParser.klass = rb_define_class_under(mXapian, "QueryParser", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__QueryParser, (void *) &cQueryParser);
  rb_define_alloc_func(cQueryParser.klass, _wrap_QueryParser_allocate);
  rb_define_method(cQueryParser.klass, "initialize", VALUEFUNC(_wrap_new_QueryParser), -1);
  rb_define_const(cQueryParser.klass, "FLAG_BOOLEAN", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_BOOLEAN)));
  rb_define_const(cQueryParser.klass, "FLAG_PHRASE", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_PHRASE)));
  rb_define_const(cQueryParser.klass, "FLAG_LOVEHATE", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_LOVEHATE)));
  rb_define_const(cQueryParser.klass, "FLAG_BOOLEAN_ANY_CASE", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_BOOLEAN_ANY_CASE)));
  rb_define_const(cQueryParser.klass, "FLAG_WILDCARD", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_WILDCARD)));
  rb_define_const(cQueryParser.klass, "FLAG_PURE_NOT", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_PURE_NOT)));
  rb_define_const(cQueryParser.klass, "FLAG_PARTIAL", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_PARTIAL)));
  rb_define_const(cQueryParser.klass, "FLAG_SPELLING_CORRECTION", SWIG_From_int(static_cast< int >(Xapian::QueryParser::FLAG_SPELLING_CORRECTION)));
  ...
  rb_define_method(cQueryParser.klass, "stemmer=", VALUEFUNC(_wrap_QueryParser_stemmere___), -1);
  rb_define_method(cQueryParser.klass, "stemming_strategy=", VALUEFUNC(_wrap_QueryParser_stemming_strategye___), -1);
  rb_define_method(cQueryParser.klass, "stopper=", VALUEFUNC(_wrap_QueryParser_stoppere___), -1);
  rb_define_method(cQueryParser.klass, "default_op=", VALUEFUNC(_wrap_QueryParser_default_ope___), -1);
  rb_define_method(cQueryParser.klass, "default_op", VALUEFUNC(_wrap_QueryParser_default_op), -1);
  rb_define_method(cQueryParser.klass, "database=", VALUEFUNC(_wrap_QueryParser_databasee___), -1);
  rb_define_method(cQueryParser.klass, "parse_query", VALUEFUNC(_wrap_QueryParser_parse_query), -1);
  rb_define_method(cQueryParser.klass, "add_prefix", VALUEFUNC(_wrap_QueryParser_add_prefix), -1);
  rb_define_method(cQueryParser.klass, "add_boolean_prefix", VALUEFUNC(_wrap_QueryParser_add_boolean_prefix), -1);
  rb_define_method(cQueryParser.klass, "stoplist_begin", VALUEFUNC(_wrap_QueryParser_stoplist_begin), -1);
  rb_define_method(cQueryParser.klass, "stoplist_end", VALUEFUNC(_wrap_QueryParser_stoplist_end), -1);
  rb_define_method(cQueryParser.klass, "unstem_begin", VALUEFUNC(_wrap_QueryParser_unstem_begin), -1);
  rb_define_method(cQueryParser.klass, "unstem_end", VALUEFUNC(_wrap_QueryParser_unstem_end), -1);
  rb_define_method(cQueryParser.klass, "add_valuerangeprocessor", VALUEFUNC(_wrap_QueryParser_add_valuerangeprocessor), -1);
  rb_define_method(cQueryParser.klass, "get_corrected_query_string", VALUEFUNC(_wrap_QueryParser_get_corrected_query_string), -1);
  rb_define_method(cQueryParser.klass, "description", VALUEFUNC(_wrap_QueryParser_description), -1);
  cQueryParser.mark = 0;
  cQueryParser.destroy = (void (*)(void *)) free_Xapian_QueryParser;
  cQueryParser.trackObjects = 0;
  ...
  cStem.klass = rb_define_class_under(mXapian, "Stem", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Stem, (void *) &cStem);
  rb_define_alloc_func(cStem.klass, _wrap_Stem_allocate);
  rb_define_method(cStem.klass, "initialize", VALUEFUNC(_wrap_new_Stem), -1);
  rb_define_method(cStem.klass, "call", VALUEFUNC(_wrap_Stem___call__), -1);
  rb_define_method(cStem.klass, "description", VALUEFUNC(_wrap_Stem_description), -1);
  rb_define_singleton_method(cStem.klass, "available_languages", VALUEFUNC(_wrap_Stem_available_languages), -1);
  cStem.mark = 0;
  cStem.destroy = (void (*)(void *)) free_Xapian_Stem;
  cStem.trackObjects = 0;
  
  cTermGenerator.klass = rb_define_class_under(mXapian, "TermGenerator", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__TermGenerator, (void *) &cTermGenerator);
  rb_define_alloc_func(cTermGenerator.klass, _wrap_TermGenerator_allocate);
  rb_define_method(cTermGenerator.klass, "initialize", VALUEFUNC(_wrap_new_TermGenerator), -1);
  rb_define_method(cTermGenerator.klass, "stemmer=", VALUEFUNC(_wrap_TermGenerator_stemmere___), -1);
  rb_define_method(cTermGenerator.klass, "stopper=", VALUEFUNC(_wrap_TermGenerator_stoppere___), -1);
  rb_define_method(cTermGenerator.klass, "document=", VALUEFUNC(_wrap_TermGenerator_documente___), -1);
  rb_define_method(cTermGenerator.klass, "document", VALUEFUNC(_wrap_TermGenerator_document), -1);
  rb_define_method(cTermGenerator.klass, "database=", VALUEFUNC(_wrap_TermGenerator_databasee___), -1);
  rb_define_const(cTermGenerator.klass, "FLAG_SPELLING", SWIG_From_int(static_cast< int >(Xapian::TermGenerator::FLAG_SPELLING)));
  rb_define_method(cTermGenerator.klass, "set_flags", VALUEFUNC(_wrap_TermGenerator_set_flags), -1);
  rb_define_method(cTermGenerator.klass, "index_text", VALUEFUNC(_wrap_TermGenerator_index_text), -1);
  rb_define_method(cTermGenerator.klass, "index_text_without_positions", VALUEFUNC(_wrap_TermGenerator_index_text_without_positions), -1);
  rb_define_method(cTermGenerator.klass, "increase_termpos", VALUEFUNC(_wrap_TermGenerator_increase_termpos), -1);
  rb_define_method(cTermGenerator.klass, "termpos", VALUEFUNC(_wrap_TermGenerator_termpos), -1);
  rb_define_method(cTermGenerator.klass, "set_termpos", VALUEFUNC(_wrap_TermGenerator_set_termpos), -1);
  rb_define_method(cTermGenerator.klass, "description", VALUEFUNC(_wrap_TermGenerator_description), -1);
  cTermGenerator.mark = 0;
  cTermGenerator.destroy = (void (*)(void *)) free_Xapian_TermGenerator;
  cTermGenerator.trackObjects = 0;
  rb_define_module_function(mXapian, "disown_Sorter", VALUEFUNC(_wrap_disown_Sorter), -1);
  
  cSorter.klass = rb_define_class_under(mXapian, "Sorter", rb_cObject);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__Sorter, (void *) &cSorter);
  rb_define_alloc_func(cSorter.klass, _wrap_Sorter_allocate);
  rb_define_method(cSorter.klass, "initialize", VALUEFUNC(_wrap_new_Sorter), -1);
  rb_define_method(cSorter.klass, "call", VALUEFUNC(_wrap_Sorter___call__), -1);
  cSorter.mark = 0;
  cSorter.destroy = (void (*)(void *)) free_Xapian_Sorter;
  cSorter.trackObjects = 0;
  
  cMultiValueSorter.klass = rb_define_class_under(mXapian, "MultiValueSorter", ((swig_class *) SWIGTYPE_p_Xapian__Sorter->clientdata)->klass);
  SWIG_TypeClientData(SWIGTYPE_p_Xapian__MultiValueSorter, (void *) &cMultiValueSorter);
  rb_define_alloc_func(cMultiValueSorter.klass, _wrap_MultiValueSorter_allocate);
  rb_define_method(cMultiValueSorter.klass, "initialize", VALUEFUNC(_wrap_new_MultiValueSorter), -1);
  rb_define_method(cMultiValueSorter.klass, "call", VALUEFUNC(_wrap_MultiValueSorter___call__), -1);
  rb_define_method(cMultiValueSorter.klass, "add", VALUEFUNC(_wrap_MultiValueSorter_add), -1);
  cMultiValueSorter.mark = 0;
  cMultiValueSorter.destroy = (void (*)(void *)) free_Xapian_MultiValueSorter;
  cMultiValueSorter.trackObjects = 0;
}
